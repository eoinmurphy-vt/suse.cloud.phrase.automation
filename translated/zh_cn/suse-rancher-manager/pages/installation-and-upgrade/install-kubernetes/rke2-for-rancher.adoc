...
Rancher 需要安装在受支持的 Kubernetes 版本上。要查找与您的Rancher版本兼容的Kubernetes版本，请参考https://rancher.com/support-maintenance-terms/[支持维护条款。]要指定RKE2版本，请在运行RKE2安装脚本时使用INSTALL_RKE2_VERSION环境变量。
