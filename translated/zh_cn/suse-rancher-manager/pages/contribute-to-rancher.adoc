...
有关如何为Rancher项目的开发做出贡献的详细信息，请参阅https://github.com/rancher/rancher/wiki[Rancher开发者维基]。维基包含许多主题的资源，包括以下内容：
...
如果您对本网站的文档有建议，请https://github.com/rancher/rancher-docs/issues/new/choose[打开]一个主要https://github.com/rancher/rancher-docs[Rancher文档]储存库中的问题。该储存库包含Rancher v2.0及更高版本的文档。

有关为Rancher v2.x文档储存库做出贡献和构建的更多详细信息，请参见https://github.com/rancher/rancher-docs#readme[Rancher文档README]。

有关描述Rancher v1.6及更早版本的文档，请参见https://github.com/rancher/rancher.github.io[Rancher 1.x文档]储存库，其中包含https://rancher.com/docs/rancher/v1.6/en/.的源文件。
