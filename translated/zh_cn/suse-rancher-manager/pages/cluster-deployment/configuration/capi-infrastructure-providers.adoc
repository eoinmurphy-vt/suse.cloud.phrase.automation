...
首先，在上游集群中配置提供程序身份，以便 CAPV 提供程序可以在您的 vSphere 服务器上创建资源。请参阅手册以获取所有身份https://github.com/kubernetes-sigs/cluster-api-provider-vsphere/blob/v1.15.2/docs/identity_management.md[选项]，以及一般的vSpherehttps://github.com/kubernetes-sigs/cluster-api-provider-vsphere/blob/v1.15.2/docs/getting_started.md[要求]。
