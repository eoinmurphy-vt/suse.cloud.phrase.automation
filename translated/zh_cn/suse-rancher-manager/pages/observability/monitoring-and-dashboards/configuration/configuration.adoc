...
有关配置 Prometheus 自定义抓取目标和规则的信息，请参考https://github.com/prometheus-operator/prometheus-operator[Prometheus Operator.]的上游文档。在 Prometheus Operator 的https://github.com/prometheus-operator/prometheus-operator/blob/main/Documentation/getting-started/design.md[设计文档]中，解释了一些最重要的自定义资源，而 Prometheus Operator 文档还可以帮助您设置 RBAC、Thanos 或自定义配置。
