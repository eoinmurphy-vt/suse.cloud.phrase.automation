...
有关`+Output+`自定义资源的详细信息，请参见https://kube-logging.github.io/docs/configuration/crds/v1beta1/output_types/[OutputSpec.]。
...
有关日志操作员支持的每个日志插件的示例配置，请参见https://kube-logging.github.io/docs/configuration/plugins/outputs/[日志操作员文档]。
