...
默认情况下，Rancher会为所有集群类型收集https://kubernetes.io/docs/concepts/overview/components/#control-plane-components[控制平面组件]和https://kubernetes.io/docs/concepts/overview/components/#node-components[节点组件]的日志。
