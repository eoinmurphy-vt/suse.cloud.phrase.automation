...
Rancher 支持 OCI 注册表的基本认证。您必须创建一个https://kubernetes.io/docs/concepts/configuration/secret/#basic-authentication-secret[*基本认证* Kubernetes 密钥]。您也可以通过{xref-secrets}[Rancher UI 创建密钥]。
