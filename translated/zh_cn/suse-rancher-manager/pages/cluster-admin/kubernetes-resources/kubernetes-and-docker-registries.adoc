...
有关更多信息，请参阅 Kubernetes 文档中关于https://kubernetes.io/docs/tasks/configure-pod-container/pull-image-private-registry/#create-a-pod-that-uses-your-secret[创建使用您密文的 Pod 的内容。]
