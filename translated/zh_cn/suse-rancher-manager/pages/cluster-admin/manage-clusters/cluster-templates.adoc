...
请参阅示例储存库以获取https://github.com/rancher/cluster-template-examples[RKE2集群模板]。
...
* Fleet储存库必须遵循这些https://documentation.suse.com/cloudnative/continuous-delivery/{fleet-docs-version}/en/explanations/gitrepo-content.html[指南]。对于RKE2集群模板，这意味着必须向储存库添加一个`+fleet.yaml+`文件。
====
