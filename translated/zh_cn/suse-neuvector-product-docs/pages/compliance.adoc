...
合规性配置文件菜单允许自定义内置模板，以符合PCI、GDPR、HIPAA、NIST、PCIv4和DISA STIG等行业标准。这些报告可以通过在安全风险->合规性菜单中选择一个标准进行过滤，然后导出。NIST合规性配置文件适用于https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-190.pdf[NIST SP 800-190].
