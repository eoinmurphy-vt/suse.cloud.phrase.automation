...
步骤中提到的所有文件均可从您所需的RKE2版本的https://scc.suse.com/rancher-docs/rancherprime/latest/en/reference-guide.html#prime-artifacts-url[Prime Artifacts URL]获取。
...
. 从https://scc.suse.com/rancher-docs/rancherprime/latest/en/reference-guide.html#prime-artifacts-url[Prime Artifacts URL]下载您所使用的RKE2版本的Windows镜像压缩包和二进制文件。
+
**使用tar.gz镜像压缩包**
