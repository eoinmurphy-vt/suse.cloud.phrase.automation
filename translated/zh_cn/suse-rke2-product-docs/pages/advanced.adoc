...
* 对于 containerd 2.0，请在 `+config-v3.toml.tmpl+` 中放置版本 3 的配置模板。请参阅https://github.com/containerd/containerd/blob/release/2.0/docs/cri/config.md[containerd 2.0 文档]以获取更多信息。
* 对于 containerd 1.7 及更早版本，请在 `+config.toml.tmpl+` 中放置版本 2 配置模板。请参阅https://github.com/containerd/containerd/blob/release/1.7/docs/cri/config.md[containerd 1.7 文档]以获取更多信息。
