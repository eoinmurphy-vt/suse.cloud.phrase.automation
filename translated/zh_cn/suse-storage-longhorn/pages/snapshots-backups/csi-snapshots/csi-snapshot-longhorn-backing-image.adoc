...
而不是直接使用 Longhorn BackingImage 资源进行 BackingImage 管理。您还可以使用通用的 Kubernetes CSI 卷快照机制。要了解有关 CSI 卷快照机制 的更多信息，请点击https://kubernetes.io/docs/concepts/storage/volume-snapshots/[这里]。
