...
要以编程方式创建Longhorn快照，您可以使用通用的Kubernetes CSI卷快照机制。要了解有关CSI卷快照机制的更多信息，请点击https://kubernetes.io/docs/concepts/storage/volume-snapshots/[这里]。
...
有关`+VolumeSnapshotClass+`的更多信息，请参见Kubernetes文档中的https://kubernetes.io/docs/concepts/storage/volume-snapshot-classes/[卷快照类]。
