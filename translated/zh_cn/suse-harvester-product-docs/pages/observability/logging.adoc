...
Harvester和Rancher都使用https://kube-logging.dev/docs/#overview[日志操作员]来管理内部日志基础设施的特定组件和操作。
...
Harvester日志基础设施允许您将Harvester日志聚合到外部服务中，例如https://www.graylog.org[Graylog]、https://www.elastic.co/elasticsearch/[Elasticsearch]、https://www.splunk.com/[Splunk]、https://grafana.com/oss/loki/[Grafana Loki]等。
...
表单显示所选https://kube-logging.dev/docs/configuration/plugins/outputs/[输出]可用的字段。

====== 输出缓冲区

编辑器允许您使用各种https://kube-logging.dev/docs/configuration/plugins/outputs/buffer/[字段]描述首选的输出缓冲区行为。
...
有关匹配指令的更多信息，请参见https://kube-logging.dev/docs/configuration/log-routing/#match-statement[匹配语句]。
...
+
--
您可以按照https://github.com/w13915984028/harvester-develop-summary/blob/main/integrate-harvester-logging-with-log-servers.md#integrate-harvester-logging-with-graylog[这里]的说明通过https://www.graylog.org/[Graylog]部署和查看集群日志：
...
+
--
您可以按照https://github.com/w13915984028/harvester-develop-summary/blob/main/test-log-event-audit-with-splunk.md[这里]的说明通过https://www.splunk.com/[Splunk]部署和查看集群日志。
...
+
--
您可以按照https://github.com/joshmeranda/harvester/blob/logging/enhancements/20220525-system-logging.md[logging HEP]中的说明通过https://grafana.com/oss/loki/[Grafana Loki]部署和查看集群日志。
...
指导`+kube-apiserver+`的策略文件是https://github.com/harvester/harvester-installer/blob/5991dcf6307aa5da79c5d6926566541f48105778/pkg/config/templates/rke2-92-harvester-kube-audit-policy.yaml[这里]。
