...
[IMPORTANT]
====
该示例包含Kubernetes密钥的默认YAML代码。除此之外，您可以使用https://wiki.archlinux.org/title/Dm-crypt/Device_encryption#Encryption_options_for_LUKS_mode[用于LUKS模式的加密选项]，这是cryptsetup的操作模式。Harvester v1.4.1 及更高版本支持这些选项，但您必须确认您的节点支持这些选项。
