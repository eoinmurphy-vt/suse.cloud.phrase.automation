...
相关问题：https://github.com/harvester/harvester/issues/8096[#8096]和https://github.com/longhorn/longhorn/issues/10741[#10741]
...
相关问题：https://github.com/harvester/harvester/issues/8354[8354]和https://github.com/longhorn/longhorn/issues/10621[10621]
...
解决方法是在升级之前，在{longhorn-product-name} UI上禁用设置https://documentation.suse.com/cloudnative/storage/1.8/en/longhorn-system/settings.html#_automatically_delete_workload_pod_when_the_volume_is_detached_unexpectedly[意外分离卷时自动删除工作负载 Pod]。升级完成后，您必须再次启用该设置。
