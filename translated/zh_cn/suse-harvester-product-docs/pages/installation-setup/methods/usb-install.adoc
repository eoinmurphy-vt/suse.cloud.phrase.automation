...
[CAUTION]
====
*已知问题:*对于v1.2.0 ISO 映像，存在一个已知https://github.com/harvester/harvester/issues/4510[问题]，即使用USB方法时交互式ISO安装会卡住。

为了解决此问题，您可以使用打补丁后的https://releases.rancher.com/harvester/v1.2.0/harvester-v1.2.0-patch1-amd64.iso[ISO]。此补丁版本仅修正了分区标签，没有其他更改。您还可以使用相关的sha512https://releases.rancher.com/harvester/v1.2.0/harvester-v1.2.0-patch1-amd64.iso.sha512sum[文件]来验证ISO。
