...
有关更多详细信息，请参阅https://kubevirt.io/2018/KubeVirt-Network-Deep-Dive.html[KubeVirt官方文档]。
...
我们利用https://github.com/k8snetworkplumbingwg/multus-cni[multus CNI]和https://www.cni.dev/plugins/current/main/bridge/[bridge CNI]来实现桥接网络。
...
管理网络基于https://projectcalico.docs.tigera.io/getting-started/kubernetes/flannel/flannel[Canal]。
