...
当创建{product_name}时，`+GitRepo+`会自动创建捆绑资源。

资源的内容对应于xref:reference/ref-crds.adoc#_bundlespec[BundleSpec]。
有关如何使用捆绑资源的更多信息，请参阅xref:how-tos-for-users/bundle-add.adoc[创建捆绑资源]。
