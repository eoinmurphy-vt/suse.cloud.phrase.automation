...
Tout d'abord, allez sur Jenkins dans votre navigateur pour rechercher le {product-name} plug-in. Cela peut être trouvé dans :
...
Pour permettre à {product-name} de scanner une image qui n'est pas sur le même hôte que le contrôleur/tout-en-un :
