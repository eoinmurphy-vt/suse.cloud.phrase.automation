...
{product-name} permet un scan et une gestion automatisés des vulnérabilités tout au long du pipeline. Les meilleures pratiques pour gérer les vulnérabilités dans {product-name} incluent :
