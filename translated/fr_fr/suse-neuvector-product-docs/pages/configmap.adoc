...
=== Exemple complet de ConfigMap {product-name} (initcfg.yaml) :
...
Exemple `+fedinitcfg.yaml+` pour le cluster principal :
...
Ensuite, créez un secret pour les sections contenant des données sensibles, telles que :
