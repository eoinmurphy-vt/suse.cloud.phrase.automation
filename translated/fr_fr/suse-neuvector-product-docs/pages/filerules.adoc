...
Voici une liste de la surveillance du système de fichiers et de ce qui est surveillé (conteneur, hôte/nœud, et/ou {product-name} Enforcer container lui-même) :
