...
[TIP]
====
Vous pouvez recharger les temps d'authentification en désactivant et en réactivant la configuration dans l'interface utilisateur de {product-name} comme suit :
