...
Vous pouvez effectuer une mise à jour en direct des {product-name} conteneurs dans ECS sans interrompre les services. Les services de {product-name} peuvent être facilement mis à jour ou mis à niveau sans interrompre les services en cours d'exécution. Pour ce faire dans Amazon ECS :
