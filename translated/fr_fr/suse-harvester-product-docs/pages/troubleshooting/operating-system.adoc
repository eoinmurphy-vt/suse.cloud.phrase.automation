...
L'utilisateur `+rancher+` peut exécuter des commandes privilégiées sans entrer de mot de passe :
...
* Pour la version `+v0.3.0+`, nous devons d'abord appliquer un contournement pour https://github.com/harvester/harvester/issues/1388[rendre certains répertoires non superposés] après avoir activé le mode lecture-écriture. Sur un nœud Harvester en cours d'exécution, exécutez la commande suivante en tant que root :
+
----
