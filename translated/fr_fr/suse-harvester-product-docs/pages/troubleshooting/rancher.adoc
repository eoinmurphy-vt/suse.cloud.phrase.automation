...
. Téléchargez le script de collecte de journaux Rancher v2.x pour Linux et générez un paquet de journaux en utilisant les commandes suivantes :
+
----
...
- Harvester : https://github.com/harvester/harvester/issues/7105[#7105] et https://github.com/harvester/harvester/issues/7284[#7284]
- Rancher : https://github.com/rancher/rancher/issues/45628[#45628] (Voir https://github.com/rancher/rancher/issues/45628#issuecomment-2246152604[ce commentaire].)