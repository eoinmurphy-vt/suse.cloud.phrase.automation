...
Si vous utilisez le fichier kubeconfig {harvester-product-name}, vous pouvez installer le produit complémentaire en effectuant les étapes suivantes :
...
+
** *Type de groupe de volumes* : Sélectionnez le type de volume local qui correspond à vos exigences. {harvester-product-name} prend actuellement en charge *striped** et *dm-thin*.
+
