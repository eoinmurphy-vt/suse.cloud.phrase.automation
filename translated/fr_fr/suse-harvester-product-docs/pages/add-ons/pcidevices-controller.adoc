...
. Allez maintenant à la page `+Advanced -> PCI Devices+` :
+
...
* https://github.com/harvester/harvester/issues/6648[Problème #6648] : Une machine virtuelle peut être programmée sur un nœud incorrect si le cluster a plusieurs instances du même périphérique PCI. 
