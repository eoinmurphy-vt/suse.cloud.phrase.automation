...
L'utilitaire https://github.com/harvester/storage-validator[`+storage-validator+`] effectue des tests de base qui valident la compatibilité d'une solution de stockage avec les opérations de cycle de vie des machines virtuelles et des volumes {harvester-product-name}. Il est conçu pour :

* Administrateurs de cluster : Vérifiez que votre solution de stockage est correctement configurée et optimisée pour {harvester-product-name}.
+
