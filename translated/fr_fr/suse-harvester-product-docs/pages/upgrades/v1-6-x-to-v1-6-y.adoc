...
Problèmes connexes : https://github.com/harvester/harvester/issues/8977[#8977] et https://github.com/longhorn/longhorn/issues/11605[#11605]

=== Le cluster invité est bloqué dans l'état "Mise à jour"

Un cluster invité {rke2-short-name} peut être bloqué dans l'état "Mise à jour" après que {harvester-product-name} a été mis à niveau. Le message d'erreur suivant s'affiche sur l'interface {harvester-product-name} :
...
Problème connexe : https://github.com/harvester/harvester/issues/8950[#8950]
...
Problèmes connexes : https://github.com/harvester/harvester/issues/8949[#8949] et https://github.com/longhorn/longhorn/issues/11479[#11479]
...
Vous pouvez voir le message d'erreur suivant lorsque vous vérifiez le contrôleur {harvester-product-name} :
...
Problème connexe : https://github.com/harvester/harvester/issues/9293[#9293]