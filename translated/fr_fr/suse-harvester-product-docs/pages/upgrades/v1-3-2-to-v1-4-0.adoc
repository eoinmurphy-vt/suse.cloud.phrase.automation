...
Issue connexe : https://github.com/harvester/harvester/issues/7005[#7005]
...
Vérifiez les journaux {harvester-product-name} et l'historique {fleet-product-name} pour les indicateurs suivants :
...
* Au lieu de cliquer sur le bouton de l'interface utilisateur {rancher-short-name}, exécutez la commande suivante contre le cluster :
+
[,shell]
----
...
Issue connexe : https://github.com/harvester/harvester/issues/7791[#7791]
