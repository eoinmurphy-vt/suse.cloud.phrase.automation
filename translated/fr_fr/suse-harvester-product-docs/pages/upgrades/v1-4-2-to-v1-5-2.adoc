...
* Sur un ordinateur avec accès à Internet, récupérez les images de conteneurs requises puis exportez-les dans un fichier TAR. Ensuite, transférez le fichier TAR vers les nœuds du cluster puis importez les images en exécutant les commandes suivantes sur chaque nœud :
+
[,bash]
----
