...
. Identifier le statut du cluster :
+
[,sh]
----
...
+
. Vérifiez les journaux du pod capi-controller-manager :
+
[,sh]
----
...
----
+
. Appliquez la solution de contournement suivante pour reprendre la mise à niveau :
+
...
Problème connexe : https://github.com/harvester/harvester/issues/6041[#6041]
