...
. Vérifiez la configuration de l'interface de gestion, puis exécutez l'une des commandes suivantes :
+
...
. Identifiez les noms des interfaces en utilisant la commande suivante :
+
[shell]
----
$ nmcli device
