...
. Dans l'interface utilisateur {harvester-product-name}, allez à *->Configurations vGPU MIG avancées* et vérifiez les éléments suivants :
+
...
----
+
Problème connexe : https://github.com/harvester/harvester/issues/5289
...
Exemple (https://docs.nvidia.com/grid/15.0/grid-vgpu-user-guide/index.html#vgpu-types-nvidia-a2[NVIDIA A2 GPU]) :
