...
=== Quels sont les avantages de {productname} ?
...
{productnameshort} est livré sous forme de conteneurs _Open Container Initiative_ (OCI) et est prévu pour être déployé sur un cluster {kube}. {productnameshort} se compose des conteneurs suivants :
...
Après une authentification et une autorisation réussies, vous pouvez configurer plusieurs aspects du produit, par exemple :
