...
{short-project-name} Liz est déployé par défaut avec 3 agents IA intégrés :
...
Alternativement, vous pouvez appliquer ce `+AIAgentConfig+` YAML à votre cluster local :
...
**Installation Programmatique:**
Alternativement, appliquez ce `+AIAgentConfig+` YAML à votre cluster local :
