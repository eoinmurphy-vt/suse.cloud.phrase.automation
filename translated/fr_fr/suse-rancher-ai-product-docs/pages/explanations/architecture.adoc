...
2. **Routage du Superviseur** : {short-project-name} identifie l'intention et achemine la requête, ainsi que le contexte de l'interface utilisateur, vers l'Agent spécialisé (par exemple, le Fleet agent).
...
6. **Réponse Finale** : {short-project-name} livre la réponse synthétisée de l'Agent à l'interface utilisateur.
