...
Ce guide est spécifique à la gamme de versions *v1.28-v1.31* de K3s et à la version *v1.10* du CIS Kubernetes Benchmark.
...
K3s prévoit des exceptions pour les rôles de cluster suivants, qui sont nécessaires pour les opérations régulières :
...
État : Pod is_compliant à true lorsque

* ServiceAccount est automountServiceAccountToken : false et Pod est automountServiceAccountToken : false ou notset
* ServiceAccount est automountServiceAccountToken : true notset et Pod est automountServiceAccountToken : false K3s accorde des exceptions aux comptes de service suivants, qui sont nécessaires pour les opérations régulières :
...
K3s accorde des exceptions aux modules suivants, qui sont nécessaires pour les opérations régulières :
