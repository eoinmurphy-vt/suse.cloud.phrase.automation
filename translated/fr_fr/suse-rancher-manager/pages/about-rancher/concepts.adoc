...
Chaque ressource informatique dans un cluster Kubernetes est appelée un _nœud_. Les nœuds peuvent être soit des serveurs sur matériel sans système d'exploitation, soit des machines virtuelles. Kubernetes classe les nœuds en trois types : _etcd_ nœuds, _nœuds de plan de contrôle_ et _nœuds de travail_.
