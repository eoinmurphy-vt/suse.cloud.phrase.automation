...
* Exigences du fournisseur de cloud Kubernetes : Un fournisseur Kubernetes spécifique au cloud pour l'infrastructure où le cluster en aval s'exécute est requis (par exemple, le https://cloud-provider-aws.sigs.k8s.io/[fournisseur de cloud Kubernetes AWS] pour CAPA ou le `+rancher-vsphere-cpi+` chart pour CAPV).
