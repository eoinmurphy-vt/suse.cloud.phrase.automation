...
Avant de créer le principal de service, vous devez obtenir les informations suivantes depuis le https://portal.azure.com[Portail Microsoft Azure] :
...
Ce qui suit crée un https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/manage-resource-groups-cli[Groupe de ressources] pour contenir vos ressources Azure :
