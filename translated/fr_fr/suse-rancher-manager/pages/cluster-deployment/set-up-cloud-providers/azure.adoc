...
+
======
. Sous la section menu:Configuration du cluster[Avancé], cliquez sur *Ajouter* sous *Arguments supplémentaires du gestionnaire de contrôleur* et ajoutez ce drapeau : `+--configure-cloud-routes=false+`
...
. Sous menu:Configuration du Cluster[Avancé], cliquez sur *Ajouter* sous *Arguments supplémentaires du gestionnaire de contrôleur* et ajoutez ce drapeau : `+--configure-cloud-routes=false+`.
...
--
[start=9]
. Les nœuds RKE2 provisionnés par Rancher ont le sélecteur `+node-role.kubernetes.io/control-plane+` défini sur `+true+`. Mettez à jour le nodeSelector :
+
[,yaml]
----
nodeSelector:
...
--
[start=9]
. Les nœuds RKE provisionnés par Rancher sont marqués `+node-role.kubernetes.io/controlplane+`. Mettez à jour les tolérances et le nodeSelector :
+
[,yaml]
----
tolerations:
