...
* GKE : `+containerd+` (voir le https://cloud.google.com/kubernetes-engine/docs/concepts/using-containerd[documents Google] pour plus d'informations)
...
... Sous *Edit Options* > *Other Configuration*, activez *Pod Security Policy* en cochant la case. Notez que vous devez également entrer une valeur supérieure à `+zero+` pour `+Manager runAsUser ID+`, `+Scanner runAsUser ID+` et `+Updater runAsUser ID+` :
+
