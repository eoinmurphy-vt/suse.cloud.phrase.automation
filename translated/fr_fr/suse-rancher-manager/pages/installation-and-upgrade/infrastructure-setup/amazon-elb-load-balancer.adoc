...
* <<_step_1_configure_load_balancer,Étape 1 : Configurer l'équilibreur de charge>>
* <<_step_2_configure_routing,Étape 2 : Configurer le routage>>
* <<_step_3_register_targets,Étape 3 : Enregistrer les cibles>>
* <<_step_4_review,Étape 4 : Revoir>>
...
=== Étape 3 : Enregistrer les cibles
...
. Utilisez `+TCP+`:``+80+`` comme *Protocole* : *Port*
