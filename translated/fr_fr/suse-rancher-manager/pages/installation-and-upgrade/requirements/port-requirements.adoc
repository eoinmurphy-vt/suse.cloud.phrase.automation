...
. Accédez à *Sécurité et utilisateurs* > *Passerelle de périmètre de sécurité* > *Zones : public* > *Ports*. Pour naviguer dans l'interface, suivez ces https://doc.opensuse.org/documentation/leap/reference/html/book-reference/cha-yast-text.html#sec-yast-cli-navigate[instructions].
...
--
. Connectez-vous à l'instance par SSH.
. Modifiez /`+etc/sysconfig/SuSEfirewall2+` et ouvrez les ports requis. Dans cet exemple, les ports 9796 et 10250 sont également ouverts pour la surveillance :
+
----
