...
[NOTE]
.Qu'est-ce qu'une URL de rappel d'autorisation ?
====
...
[NOTE]
.Où puis-je trouver le Client ID et le Client Secret ?
====
...
+
_Tous_ les utilisateurs GitHub peuvent accéder à Rancher. Nous décourageons généralement l'utilisation de ce paramètre !
