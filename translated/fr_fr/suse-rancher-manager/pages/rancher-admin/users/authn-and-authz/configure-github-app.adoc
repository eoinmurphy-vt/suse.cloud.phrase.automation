 ...
 ** *Nom de l'application GitHub* : Tout ce que vous voulez, par exemple `+My Rancher+`.
 ** *Description de l'application* : Optionnel, peut être laissé vide.
 ** *URL de la page d'accueil* : `+https://localhost:8443+`.
 ** *URL de rappel* : `+https://localhost:8443/verify-auth+`.
