...
* `+user-last-login-default+` : Si un utilisateur n'a pas `+UserAttribute.LastLogin+` défini sur son compte, ce paramètre est utilisé à la place. La valeur est exprimée comme un https://datatracker.ietf.org/doc/html/rfc3339#section-5.6[date-heure RFC 3339] tronquée à la dernière seconde ; par exemple, `+2023-03-01T00:00:00Z+`. Si la valeur est définie sur une chaîne vide ou est égale à 0, ce paramètre n'est pas utilisé.
