...
* https://youtu.be/YNCq-prI8-8[Le RanchCast - Épisode 1 : Fournisseur Terraform Rancher 2] : Dans cette démonstration, le directeur de la communauté Jason van Brackel explique comment utiliser le fournisseur Terraform Rancher 2 pour provisionner des nœuds et créer un cluster personnalisé.
