...
En tant qu'opérateur de projet basé sur https://github.com/rancher/helm-project-operator[rancher/helm-project-operator], Prometheus Federator a trois classifications différentes d'espaces de noms que l'opérateur surveille :
