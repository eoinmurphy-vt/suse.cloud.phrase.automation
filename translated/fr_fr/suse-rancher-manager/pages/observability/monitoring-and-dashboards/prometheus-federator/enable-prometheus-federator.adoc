...
. Ouvrez le projet `+System+` pour vérifier vos espaces de noms :
+
Cliquez sur menu:Cluster[Projets/Espaces de noms] dans l'interface utilisateur de Rancher. Cela affichera tous les espaces de noms dans le projet `+System+` :
+
 ...
 ** Sélectionnez *⋮* à droite de l'espace de noms, cliquez sur *Déplacer*, puis choisissez `+System+` dans le menu déroulant *Projet cible* :
+
