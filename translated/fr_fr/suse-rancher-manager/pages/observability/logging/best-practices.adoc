...
Ce flux de journaux est ensuite automatiquement collecté selon les _Flux_ ou _ClusterFlows_ que vous avez configurés. Vous souhaiterez peut-être également envisager de créer un _Flux_ spécifiquement pour ce fichier journal en ciblant le nom du conteneur. Voir l'exemple :
