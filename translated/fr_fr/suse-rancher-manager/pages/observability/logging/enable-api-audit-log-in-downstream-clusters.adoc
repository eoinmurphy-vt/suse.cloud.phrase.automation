...
--
[pass]
<h2><a id="_method_1_recommended_set_audit_policy_file_in_machineglobalconfig_or_machineselectorconfig"></a>Méthode 1 (Recommandée) : Set `+audit-policy-file+` in `+machineGlobalConfig+` or `+machineSelectorConfig+`</h2>
...
[pass]
<h2><a id="_method_2_use_the_directives_machineselectorfiles_and_machineglobalconfig"></a>Méthode 2 : Utilisez les Directives, `+machineSelectorFiles+` et `+machineGlobalConfig+`</h2>
