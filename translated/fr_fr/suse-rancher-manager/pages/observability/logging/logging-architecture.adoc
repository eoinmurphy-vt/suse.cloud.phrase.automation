...
La figure suivante tirée de la https://kube-logging.github.io/docs/#architecture[documentation de l'opérateur de journalisation] montre la nouvelle architecture de journalisation :
