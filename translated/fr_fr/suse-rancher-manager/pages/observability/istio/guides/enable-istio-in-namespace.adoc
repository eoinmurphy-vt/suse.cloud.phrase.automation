...
[WARNING]
====
https://github.com/rancher/charts/tree/release-v2.11/charts/rancher-istio[Rancher-Istio] n'est plus pris en charge depuis Rancher v2.12.0 ; passez à la version https://apps.rancher.io[SUSE Application Collection] d'Istio pour une sécurité renforcée (incluse dans les abonnements SUSE Rancher Prime).
...
== {xref-istio-sidecar}[Suivant : Ajouter des déploiements avec le sidecar Istio]
