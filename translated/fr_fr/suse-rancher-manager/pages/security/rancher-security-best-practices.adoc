...
Vous devez protéger les ports suivants derrière un {xref-l4-l7-lb}#_layer_4_load_balancer[équilibreur de charge externe] qui a le déchargement SSL activé :
...
* https://cheatsheetseries.owasp.org/cheatsheets/Authentication_Cheat_Sheet.html[Feuille de triche OWASP : Authentification]
...
* https://cheatsheetseries.owasp.org/cheatsheets/Rate_Limiting_Cheat_Sheet.html[Feuille de triche OWASP : Limitation de taux]
...
* {xref-project-resource-quotas}[Quotas de ressources de projet]
* https://owasp.org/API-Security/editions/2023/en/0xa4-lack-of-resources-rate-limiting/[OWASP API Security Top 10 - API4:2019 - Manque de ressources et limitation de taux]
* https://cheatsheetseries.owasp.org/cheatsheets/Rate_Limiting_Cheat_Sheet.html[OWASP Aide-mémoire : Limitation de taux]
