...
. Ajoutez le nom de la version de benchmark à la section `+target_mapping+` du `+config.yaml+` :
+
[,yaml]
----
 target_mapping:
...
. Téléchargez ce répertoire sur votre cluster Kubernetes en créant un ConfigMap :
+
[,yaml]
----
