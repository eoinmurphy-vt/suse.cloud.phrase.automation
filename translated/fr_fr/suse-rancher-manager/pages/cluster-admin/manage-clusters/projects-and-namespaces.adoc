...
. <<_recommended_add_project_members,Recommandé : Ajoutez des membres au projet.>>
. <<_optional_add_resource_quotas,Facultatif : Ajoutez des quotas de ressources.>>
...
* Choisissez `+Custom+` pour créer un rôle personnalisé à la volée : {xref-cluster-project-roles}#_custom_project_roles[Rôles de projet personnalisés].
====
