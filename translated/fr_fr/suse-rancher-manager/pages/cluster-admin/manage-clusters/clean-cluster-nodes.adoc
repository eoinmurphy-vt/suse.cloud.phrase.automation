...
. Rendez le script exécutable en exécutant la commande suivante depuis le même répertoire que `+user-cluster.sh+` :
+
----
...
Pour supprimer l'agent-système-rancher, exécutez le script https://github.com/rancher/system-agent/blob/main/system-agent-uninstall.sh[system-agent-uninstall.sh] :
