...
Pour plus d'informations sur l'utilisation de kubectl, consultez https://kubernetes.io/docs/reference/kubectl/overview/[Documentation Kubernetes : Vue d'ensemble de kubectl].
