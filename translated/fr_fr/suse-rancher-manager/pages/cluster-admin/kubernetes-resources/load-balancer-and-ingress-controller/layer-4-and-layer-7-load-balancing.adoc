...
:description: Kubernetes prend en charge l'équilibrage de charge de deux manières : Équilibrage de la charge de couche 4 et équilibrage de la charge de couche 7. Découvrez le support pour chaque méthode dans différents déploiements
