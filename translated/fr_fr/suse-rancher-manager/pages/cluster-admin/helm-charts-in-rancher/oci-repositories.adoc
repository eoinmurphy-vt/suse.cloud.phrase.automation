...
[NOTE]
====
Vous pouvez utiliser le champ *URL OCI* pour affiner le nombre de graphiques disponibles à l'installation sur Rancher. Des points de terminaison plus génériques ciblent plus de graphiques, comme le démontrent les exemples suivants :
...
. (facultatif) Si votre dépôt a une stratégie de limitation de taux et peut répondre avec le code d'état `+429 Too Many Requests+`, vous voudrez peut-être remplir les champs sous *Exponential Back Off* :
