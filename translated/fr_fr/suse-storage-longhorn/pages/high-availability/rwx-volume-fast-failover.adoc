...
L'équipe Longhorn a étudié l'impact des volumes RWX sur la consommation des ressources et les performances du système. Les études de benchmarking, qui ont été réalisées en utilisant 60 volumes RWX, montrent que l'activation de la fonctionnalité _RWX Volume Fast Failover_ entraîne les résultats suivants :
