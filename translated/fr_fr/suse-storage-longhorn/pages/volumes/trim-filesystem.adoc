...
* Volume RWX : Le point de montage est le pod gestionnaire de partage du volume. Le pod gestionnaire de partage contient le serveur NFS et est généralement nommé `+share-manager-<volume name>+`.
...
* Si vous souhaitez toujours rogner un volume Longhorn chiffré, vous pouvez :
 ...
 .. Activez le flag `+discards+` pour le volume chiffré. La phrase de passe est enregistrée dans le secret correspondant :
+
