...
* Chiffrement des volumes en mode `+Filesystem+` : (https://github.com/longhorn/longhorn/issues/1859[#1859])
* Chiffrement des volumes en mode `+Block+` : (https://github.com/longhorn/longhorn/issues/4883[#4883])
