...
Kubernetes prend en charge les 2 https://kubernetes.io/docs/concepts/storage/persistent-volumes/#volume-mode[modes de volume] pour PVC : Système de fichiers et bloc.
