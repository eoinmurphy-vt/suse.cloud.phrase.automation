...
{longhorn-product-name} prend en charge les modes d'accès PersistentVolume Kubernetes suivants :
...
. Utilisez la commande suivante pour créer une StorageClass appelée `+longhorn+` :
+
...
. Créez un Pod qui utilise des volumes Longhorn en exécutant cette commande :
+
[subs="+attributes", console]
----
