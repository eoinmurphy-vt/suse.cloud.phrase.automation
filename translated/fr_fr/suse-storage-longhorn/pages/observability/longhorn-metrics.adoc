...
| État du volume. Cette métrique utilise l'étiquette `+state+` pour indiquer l'état actuel du volume. La valeur est 1 pour l'état actuel et 0 pour les autres. États : création, attaché, détaché, en cours d'attachement, en cours de détachement, en cours de suppression 
...
| Robustesse du volume. Cette métrique utilise l'étiquette `+state+` pour indiquer la robustesse actuelle. La valeur est 1 pour l'état actuel et 0 pour les autres. États : inconnu, sain, dégradé, défectueux
...
| Statut de ce nœud : 1=true, 0=false
...
| État du composant d'exécution actuel de la réplique : en cours d'exécution, arrêté, erreur, démarrage, arrêt, inconnu 
...
| État du composant d'exécution d'un moteur : en cours, arrêté, erreur, démarrage, arrêt, inconnu 
| longhorn_engine_state{engine="testvol-e-0", volume="testvol", node="node-1", state="running"} 1 

| longhorn_engine_replica_mode 
| Le mode signalé pour chaque réplique par le moteur : RW, WO, ERR 
...
| État de cette sauvegarde : 0=Nouveau, 1=En attente, 2=En cours, 3=Terminé, 4=Erreur, 5=Inconnu
...
| État de cette image de sauvegarde : 0=En attente, 1=Démarrage, 2=En cours, 3=Prêt pour le transfert, 4=Prêt, 5=Échoué, 6=Échoué et nettoyage, 7=Inconnu
...
| État de cette image de base de sauvegarde : 0=Nouveau, 1=En attente, 2=En cours, 3=Terminé, 4=Erreur, 5=Inconnu
