...
* Attributs SMART : https://www.smartmontools.org/wiki/TocDoc[documentation smartmontools]
* Données de santé SPDK NVMe : https://github.com/spdk/spdk/blob/v25.09/doc/jsonrpc.md.jinja2#L4805-L4856[`+bdev_nvme_get_controller_health_info+` JSON-RPC]
====
