...
* `+task+` : Type de travail. {longhorn-product-name} prend en charge les éléments suivants :
...
. `+isGroup+` : est le nom qui appartient à un travail récurrent ou à un groupe de travaux récurrents, soit `+true+` soit `+false+`.
