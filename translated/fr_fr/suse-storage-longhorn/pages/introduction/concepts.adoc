...
Pour les volumes v1, {longhorn-product-name} utilise iSCSI, ce qui peut nécessiter une configuration supplémentaire sur vos nœuds :
...
Les étapes suivantes montrent une répartition plus détaillée de la façon dont {longhorn-product-name} ajoute de nouvelles répliques :
