...
* SUSE ou openSUSE : https://documentation.suse.com/sles/15-SP4/html/SLES-all/cha-mod.html#sec-mod-modprobe-d[Charger les modules de kernel au démarrage]
* Ubuntu : https://manpages.ubuntu.com/manpages/jammy/man5/modules-load.d.5.html[Configurer les modules de kernel pour se charger au démarrage]
* RHEL : https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/managing_monitoring_and_updating_the_kernel/managing-kernel-modules_managing-monitoring-and-updating-the-kernel[Charger les modules de kernel automatiquement au démarrage du système]
...
[NOTE]
====
À partir de la version 1.11.0, {longhorn-product-name} empêche l'ajout de disques de bloc contenant un système de fichiers ou une table de partition existante pour éviter toute perte de données inattendue. Assurez-vous que le disque est propre avant de l'ajouter en exécutant :
