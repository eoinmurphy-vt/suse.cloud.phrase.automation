...
* *Exigence d'état du volume* : Le paramètre ne peut être modifié que lorsque aucun volume V2 n'est attaché. {longhorn-product-name} bloque les mises à jour si un volume V2 est actif.
