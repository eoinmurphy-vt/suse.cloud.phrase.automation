...
-- | -- | --
`+Other Longhorn Manager+` | 9500 | TCP
`+Instance Manager+` | 8500 (service processus) ; 8501 (service proxy) ; 8502 (service disque) ; 8503 (service instance) ; 8504 (service spdk) | TCP
...
De | Port | Protocole
-- | -- | --
`+Longhorn Manager+` | 8500 (service processus) ; 8501 (service proxy) ; 8502 (service disque) ; 8503 (service d'instance) ; 8504 (service spdk) | TCP
