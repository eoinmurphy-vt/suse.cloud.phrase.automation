...
+
Importez le fichier https://github.com/longhorn/longhorn-tests/blob/master/manager/integration/tests/longhorn.py[longhorn.py] qui contient le client Python dans votre script Python et créez un client à partir du point de terminaison :
+
