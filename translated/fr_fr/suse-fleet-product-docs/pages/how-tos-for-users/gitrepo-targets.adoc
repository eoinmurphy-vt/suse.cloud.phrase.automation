...
Au lieu de déployer l'application sur chaque cluster, {product_name} vous permet de déployer sur tous les clusters en suivant ces étapes :
...
. La règle suivante sera définie dans `+fleet.yaml+` :
