...
[NOTE]
====
Dans ce cas, {product_name} téléchargera des artefacts OCI. Cela signifie que :
...
Les conditions suivantes doivent être remplies sur une ressource HelmOp pour que {product_name} puisse activer le sondage dessus :
...
Lorsque le sondage est activé, {product_name} effectue les actions suivantes à l'intervalle configuré :
