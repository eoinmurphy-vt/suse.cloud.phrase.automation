...
*  **Multiples finaliseurs** : Ressources avec plus d'un finaliseur (indique des bogues - seuls les Contents devraient avoir plusieurs finaliseurs pour le comptage de référence, dans {product_name} v0.11.1 à v0.14.x)
...
La commande monitor suit les hachages des engagements Git tout au long du cycle de vie :
