...
La ressource `+Schedule+` définit des fenêtres temporelles pendant lesquelles {product_name} accepte des modifications à `+Clusters+`.

Pour plus d'informations sur la procédure d'utilisation de la ressource `+Schedule+`, référez-vous à xref:experimental-features/scheduling.adoc[Planification].
