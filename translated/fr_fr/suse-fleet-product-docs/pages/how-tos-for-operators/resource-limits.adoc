...
{product_name} prend en charge la configuration des demandes et des limites de ressources pour l’UC et la mémoire à deux endroits :
...
Les clés de composant prises en charge sont :
