...
Les champs d'application de la topologie sont une fonctionnalité de sécurité pour les sujets au sein de SUSE Observability. Les rôles prédéfinis SUSE Observability Administrator, Power User et Guest n'ont pas d'étendue de topologie définie.
