...
* Injection d'en-tête de trace et observation de traces sur du trafic non crypté
...
* La nacelle a été fixée à `+http-header-injector.stackstate.io/inject: enabled+` 
