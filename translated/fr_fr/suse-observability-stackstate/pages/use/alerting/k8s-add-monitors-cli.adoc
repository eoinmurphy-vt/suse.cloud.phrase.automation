...
Pour modifier un moniteur, modifiez l'original du moniteur qui a été appliqué, puis appliquez-le à nouveau. Il existe également une commande `+sts monitor edit+` pour éditer directement le moniteur configuré dans l'instance SUSE Observability :
