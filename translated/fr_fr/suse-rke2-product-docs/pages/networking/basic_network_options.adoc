...
spec:
  valuesContent: |-
    flannel:
      iface: "eth1"
----
Pour utiliser le https://github.com/flannel-io/flannel/blob/master/Documentation/backends.md#wireguard[backend WireGuard] de Flannel (https://www.wireguard.com/install/[Les utilisateurs de noyaux < 5.6 doivent installer un module]), les valeurs de graphique suivantes doivent être utilisées :
...
Cilium comprend également une plateforme d'observabilité appelée https://docs.cilium.io/en/stable/overview/intro/#what-is-hubble[Hubble]. Pour activer Hubble, utilisez les valeurs de graphique suivantes :
