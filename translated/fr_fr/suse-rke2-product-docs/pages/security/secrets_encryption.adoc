...
RKE2 prend en charge https://kubernetes.io/docs/tasks/administer-cluster/encrypt-data/[le chiffrement des secrets au repos], et effectuera automatiquement les actions suivantes :
...
RKE2 prend en charge les https://kubernetes.io/docs/tasks/administer-cluster/encrypt-data/#providers[fournisseurs de chiffrement] suivants :
...
----
. Redémarrez le pod `+kube-apiserver+` :
+
[,sh]
----
