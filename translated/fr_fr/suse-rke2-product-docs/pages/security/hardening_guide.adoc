...
+
--
Sur v1.25 et versions ultérieures, https://kubernetes.io/docs/concepts/security/pod-security-admission/[Admission de Sécurité des Pods (PSA)] sont utilisés pour la sécurité des pods. Un fichier de configuration par défaut pour l'Admission de Sécurité des Pods sera ajouté au cluster au démarrage comme suit : 
