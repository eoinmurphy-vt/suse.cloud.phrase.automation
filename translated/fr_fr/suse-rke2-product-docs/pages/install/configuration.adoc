...
Comme indiqué, le script d'installation est principalement concerné par la configuration de RKE2 pour fonctionner en tant que service. Si vous choisissez de ne pas utiliser le script, vous pouvez exécuter RKE2 simplement en téléchargeant le binaire depuis notre https://github.com/rancher/rke2/releases/latest[page de version], en le plaçant dans votre chemin, et en l'exécutant. Les commandes importantes sont :
