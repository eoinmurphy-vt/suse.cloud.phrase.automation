...
.Version Gate
====
L'option `+disable-default-registry-endpoint+` est disponible en tant que fonctionnalité expérimentale à partir des versions de février 2024 : v1.26.13+rke2r1, v1.27.10+rke2r1, v1.28.6+rke2r1, v1.29.1+rke2r1
====
...
Par exemple, la configuration suivante extrairait de manière transparente l'image `+rancher/rke2-runtime:v1.30.1-rke2r1+` de `+registry.example.com:5000/mirrorproject/rancher-images/rke2-runtime:v1.30.1-rke2r1+` :
...
.Version Gate
====
La prise en charge des caractères génériques est disponible depuis les versions de mars 2024 : v1.26.15+rke2r1, v1.27.12+rke2r1, v1.28.8+rke2r1, v1.29.3+rke2r1.
====
