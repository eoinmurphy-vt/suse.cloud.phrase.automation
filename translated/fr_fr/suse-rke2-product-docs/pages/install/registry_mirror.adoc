...
.Version Gate
====
Le miroir de registre intégré est disponible en tant que fonctionnalité expérimentale à partir des versions de janvier 2024 : v1.26.13+rke2r1, v1.27.10+rke2r1, v1.28.6+rke2r1, v1.29.1+rke2r1 et en version GA à partir des versions de décembre 2024 : v1.29.12+rke2r1, v1.30.8+rke2r1, v1.31.4+rke2r1.
====
...
.Version Gate
====
Le support des caractères génériques est disponible à partir des versions de mars 2024 : v1.26.15+rke2r1, v1.27.12+rke2r1, v1.28.8+rke2r1, v1.29.3+rke2r1
====
...
Notez que si vous utilisez l'option `+disable-default-endpoint+` et souhaitez autoriser le tirage directement à partir d'un registre particulier, tout en interdisant les autres, vous pouvez fournir explicitement un point de terminaison afin de permettre au tirage d'images de revenir au registre lui-même :
