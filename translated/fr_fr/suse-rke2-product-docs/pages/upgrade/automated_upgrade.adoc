...
Les deux plans d'exemple suivants maintiendront continuellement votre cluster à jour vers la dernière version stable, en ciblant le canal xref:upgrade/manual_upgrade.adoc#_release_channels[release channel] :
