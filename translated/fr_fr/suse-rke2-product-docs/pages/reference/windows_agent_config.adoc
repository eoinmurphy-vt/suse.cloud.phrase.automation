...
L'installation de Calico sur Windows peut être personnalisée à l'aide de variables d'environnement. Vous pouvez spécifier ces variables comme suit :
