...
Le site {elemental_operator_name} permet de contrôler les nœuds {elemental-product-name} en étendant les API Kubernetes avec un ensemble de Kubernetes _elemental.cattle.io_ https://kubernetes.io/docs/tasks/extend-kubernetes/custom-resources/custom-resource-definitions/[CRD]:
