...
La liste des versions valides pour le champ `+kubernetesVersion+` peut être déterminée à partir des métadonnées de Rancher à l'aide des commandes suivantes.
