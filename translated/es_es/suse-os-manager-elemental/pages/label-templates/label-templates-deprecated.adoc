...
Las familias de variables *SMBIOS* y *Hardware* han quedado obsoletas en el Elemental Operator v1.7.0.

Aunque estas familias de variables todavía se representan correctamente en las versiones actuales del Elemental Operator, su soporte se eliminará en futuras versiones del Elemental Operator.

Si todavía estás utilizando estas antiguas familias de variables de las plantillas de etiquetas, por favor cambia a xref:label-templates/label-templates.adoc#_label_templates_variables[las más nuevas disponibles] si es posible.

Para simplificar la adopción de las nuevas variables, consulta las tablas que mapean las variables obsoletas a las nuevas soportadas:

* <<_hardware_labels_to_new_label_templates_variables_table,Etiquetas de Hardware a nuevas variables de plantillas de etiquetas>>
* <<_smbios_labels_to_new_label_templates_variable_table,Etiquetas SMBIOS a nuevas variables de plantillas de etiquetas>>

== Tabla de etiquetas de hardware a nuevas variables de plantillas de etiquetas

|===
| Variable obsoleta | Variable nueva equivalente

| `+${System Data/Block Devices/Number Devices}+`
| `+${Storage/TotalDisks}+`

| `+${Datos del Sistema/Dispositivos de Bloque/_<DeviceName>_/Tipo de Unidad} +`
| `+${Storage/Disks/_<DeviceName>_/DriveType}+`

| `+${Datos del Sistema/Dispositivos de Bloque/_<DeviceName>_/Nombre} +`
| `+${Storage/Disks/_<DeviceName>_/Name}+`

| `+${Datos del Sistema/Dispositivos de Bloque/_<DeviceName>_/Extraíble} +`
| `+${Storage/Disks/_<DeviceName>_/Removable}+`

| `+${Datos del Sistema/Dispositivos de Bloque/_<DeviceName>_/Tamaño} +`
| `+${Storage/Disks/_<DeviceName>_/Size}+`

| `+${Datos del Sistema/Dispositivos de Bloque/_<DeviceName>_/Controlador de Almacenamiento} +`
...
== Tabla de etiquetas SMBIOS a nuevas variables de plantillas de etiquetas
