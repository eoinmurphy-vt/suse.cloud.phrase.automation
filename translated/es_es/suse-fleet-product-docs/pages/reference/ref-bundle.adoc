...
Los paquetes se crean automáticamente por {product_name} cuando se crea un `+GitRepo+`.

El contenido del recurso corresponde a la xref:reference/ref-crds.adoc#_bundlespec[BundleSpec].
Para más información sobre cómo utilizar el recurso de paquete xref:how-tos-for-users/bundle-add.adoc[Crear un recurso de paquete].
