...
O recurso `+Schedule+` define janelas de tempo durante as quais {product_name} aceita alterações em `+Clusters+`.

Para mais informações sobre como usar o recurso `+Schedule+`, consulte xref:experimental-features/scheduling.adoc[Agendamento].
