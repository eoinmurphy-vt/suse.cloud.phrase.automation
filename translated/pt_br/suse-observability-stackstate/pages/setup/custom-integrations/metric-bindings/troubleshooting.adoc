...
* <<_the_metric_chart_doesnt_show_on_the_highlights_page_of_a_component,O gráfico de métricas não aparece na página de Destaques de um componente>>
* <<_the_metric_chart_doesnt_show_on_the_metrics_perspective_of_a_component,O gráfico de métricas não aparece na perspectiva de métricas de um componente>>
...
. Abra a visualização de exploração, através de Visualizações no menu e do botão azul "Explorar" à direita. Ou diretamente via URL: `+https://<your-stackstate-instance>/#/views/explore+`
...
* Os dados estão sendo coletados para este componente (seja via o agente {stackstate-product-name} ou por outros meios)?
