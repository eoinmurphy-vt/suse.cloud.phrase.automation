...
https://github.com/harvester/kubeovn-operator[`+kubeovn-operator+`]は、基盤となる{harvester-product-name}クラスター上でのhttps://github.com/kubeovn/kube-ovn[Kube-OVN]のライフサイクルを管理するために使用されます。
