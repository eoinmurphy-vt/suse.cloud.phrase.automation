...
----
+
. 影響を受けたノードのホスト名を特定し、サービス証明書が期限切れになるかどうかを確認するためにhttps://github.com/harvester/harvester/issues/3863#issuecomment-1539681311[回避策]を実施します。
+
[,sh]
----
...
[NOTE]
====
複数のノードが同時にクラスターに参加した場合、すべてのノードでhttps://github.com/harvester/harvester/issues/3863#issuecomment-1539681311[回避策]を実施する必要があります。
====
