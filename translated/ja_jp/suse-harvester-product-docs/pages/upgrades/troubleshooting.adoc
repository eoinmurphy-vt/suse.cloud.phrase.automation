...
* アップグレードhttps://github.com/harvester/harvester/blob/master/enhancements/20220413-zero-downtime-upgrade.md[設計提案]に目を通してください。次のセクションでは、アップグレード内のフェーズと可能な診断方法について簡単に説明します。
