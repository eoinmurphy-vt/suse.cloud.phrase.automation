...
[CAUTION]
====
アップグレードを開始する前に、`+BackingImage+` CRDがhttps://github.com/longhorn/longhorn/blob/v1.7.2/deploy/longhorn.yaml#L486-L690[{longhorn-product-name} *v1.7.2*バージョン]に更新されていることを確認してください。
