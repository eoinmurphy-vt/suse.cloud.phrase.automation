...
私たちはhttps://github.com/k8snetworkplumbingwg/multus-cni[multus CNI]とhttps://www.cni.dev/plugins/current/main/bridge/[bridge CNI]を活用して、ブリッジネットワークを実装します。
...
管理ネットワークはhttps://projectcalico.docs.tigera.io/getting-started/kubernetes/flannel/flannel[Canal]に基づいています。
