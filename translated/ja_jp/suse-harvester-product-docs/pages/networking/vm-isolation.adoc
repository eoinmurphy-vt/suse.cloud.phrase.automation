...
スキーマと使用ガイドラインの詳細については、Kube-OVNのドキュメントにあるhttps://kubeovn.github.io/docs/v1.13.x/en/guide/subnet/#subnet-acl[サブネットACL]およびhttps://kubeovn.github.io/docs/v1.13.x/en/reference/kube-ovn-api/#acl[ACL APIリファレンス]を参照してください。
...
詳細については、Kubernetesドキュメントのhttps://kubernetes.io/docs/concepts/services-networking/network-policies[Network Policies]およびKube-OVNドキュメントのhttps://kubeovn.github.io/docs/v1.13.x/en/guide/networkpolicy-log[NetworkPolicy Logging]を参照してください。
