...
ウィットネスノードはデータを保存しませんが、etcdノードのためのhttps://etcd.io/docs/v3.3/op-guide/hardware/[ハードウェア推奨事項]は依然として考慮されるべきです。リソースが限られたハードウェアを使用すると、クラスターのパフォーマンスに大きな影響を与えます。これは、記事https://www.suse.com/support/kb/doc/?id=000020100[遅いetcdパフォーマンス（パフォーマンステストと最適化）]で説明されています。
