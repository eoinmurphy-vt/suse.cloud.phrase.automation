...
{harvester-product-name}オペレーティングシステムは、https://github.com/rancher/elemental-toolkit[elemental-toolkit]を使用しており、これは独自のhttps://rancher.github.io/elemental-toolkit/docs/reference/cloud_init/[cloud-initサポート]を持っています。
