...
[CAUTION]
====
*既知の問題:*v1.2.0 ISOイメージには、USB方式を使用したインタラクティブISOインストールが停止する既知のhttps://github.com/harvester/harvester/issues/4510[問題]があります。

これを解決するには、パッチが適用されたhttps://releases.rancher.com/harvester/v1.2.0/harvester-v1.2.0-patch1-amd64.iso[ISO]を使用できます。このパッチ版はパーティションラベルのみを修正し、他に変更はありません。関連するsha512https://releases.rancher.com/harvester/v1.2.0/harvester-v1.2.0-patch1-amd64.iso.sha512sum[ファイル]を使用してISOを検証することもできます。
