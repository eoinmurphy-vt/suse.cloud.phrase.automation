...
[NOTE]
====
ユーティリティによって実行されるテストは、将来のリリースでhttps://www.suse.com/product-certification/suse-certified/data-protection-for-virtualization-certification[SUSE仮想化向け認定データ保護]の認証要件を満たすように拡張されます。
====
...
`+storage-validator+`実行可能ファイルをhttps://github.com/harvester/storage-validator/releases[リリース]ページからダウンロードできます。
