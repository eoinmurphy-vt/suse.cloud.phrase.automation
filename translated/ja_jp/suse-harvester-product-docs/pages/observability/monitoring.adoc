...
また、ユーザーはhttp://grafana.com/[Grafana]ダッシュボードリンクをクリックして、Grafana UI上の他のダッシュボードを表示できます。
...
すでにアップストリームの変更を追跡するためのhttps://github.com/harvester/harvester/issues/2760[GitHub issue]を作成しました。機能が利用可能になると、{harvester-product-name}がそれを採用します。
