...
HarvesterはopenSUSEベースのOSで動作します。このOSはhttps://github.com/rancher/elemental-toolkit[elemental-toolkit]によって生成されたアーティファクトです。以下のセクションには、ユーザーがOS関連の問題をトラブルシューティングするための情報とヒントが含まれています。
...
[NOTE]
====
環境に応じてhttps://www.kernel.org/doc/html/latest/admin-guide/serial-console.html[コンソールオプション]を調整してください。*必ず*行の最後に`+console=+`文字列を追加してください。
====
