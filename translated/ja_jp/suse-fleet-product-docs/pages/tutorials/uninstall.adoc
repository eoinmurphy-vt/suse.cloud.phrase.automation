...
ただし、{product_name}はhttps://kubernetes.io/docs/concepts/overview/working-with-objects/finalizers/[finalizers]を使用しているため、{product_name}コントローラーがクリーンアップする時間を与えるために、最初にワークロードをアンインストールしてください。
