...
ifeval::["{product}" == "fleet"]
`+GlobalRole+`をユーザーまたはグループに割り当てます。詳細はhttps://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/manage-role-based-access-control-rbac/global-permissions#configuring-global-permissions-for-individual-users[Rancher docs]で確認できます。
endif::[]

ifeval::["{product}" == "continuous-delivery"]

`+GlobalRole+`をユーザーまたはグループに割り当てます。詳細はhttps://documentation.suse.com/cloudnative/rancher-manager/v2.12/en/rancher-admin/users/authn-and-authz/manage-role-based-access-control-rbac/global-permissions.html#_configuring_global_permissions_for_individual_users[Rancher docs]で確認できます。
endif::[]
