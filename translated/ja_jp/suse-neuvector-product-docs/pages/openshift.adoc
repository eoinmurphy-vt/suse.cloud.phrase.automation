...
CRI-Oランタイムを使用している場合は、このhttps://raw.githubusercontent.com/neuvector/manifests/main/kubernetes/5.4.0/neuvector-crio-oc.yaml[CRI-Oサンプル]を参照してください。
