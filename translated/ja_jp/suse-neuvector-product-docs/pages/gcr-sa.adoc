...
. レジストリ - これは、GCRインスタンスから正しいデータが収集されることを確認したい最初の場所です。https://gcr.ioの例は最も一般的ですが、GCPでのGCRの設定が正確に反映されることを確認したいと思います。例えば、それはhttps://us.gcr.ioかもしれません。次のセクションで確認しましょう。
