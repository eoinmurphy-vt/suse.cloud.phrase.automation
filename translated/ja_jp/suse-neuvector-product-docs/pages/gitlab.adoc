...
{product-name}は、GitLabビルドパイプラインでトリガーされた脆弱性をスキャンするように設定できます。ここに設定して使用可能なhttps://gitlab.com/neuvector/gitlab-plugin[GitLabプラグイン]があります。プラグインの使用については、GitLabサイトの指示に従ってください。
