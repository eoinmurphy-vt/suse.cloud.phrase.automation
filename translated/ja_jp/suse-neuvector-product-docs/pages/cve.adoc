...
| 2025年1月15日
| 該当なしhttps://github.com/neuvector/neuvector/releases/tag/v5.4.2[v5.4.2]で*false positive*としてフラグが立てられました。

| https://github.com/advisories/GHSA-v23v-6jw2-98fq[CVE-2024-41110]
| 一部のDocker Engineバージョンにおけるセキュリティ脆弱性により、攻撃者がhttps://docs.docker.com/engine/extend/plugins_authorization/[認可プラグイン（AuthZ）]をバイパスできる可能性があります。悪用の可能性は低いです。
| 2024年11月16日
...
| `+jwt-go+`は、`+[]string{}+`が`+m["aud"]+`に使用されるときに攻撃者がアクセス制限をバイパスできるようにします。ユーザーはhttps://github.com/golang-jwt/jwt[`+golang-jwt+`] v3.2.1に移行するべきです。
| 2024年11月16日
| https://github.com/neuvector/neuvector/releases/tag/v5.4.1[NeuVector v5.4.1]
|===
