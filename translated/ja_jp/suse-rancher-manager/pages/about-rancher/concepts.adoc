...
Kubernetesクラスタの状態はhttps://kubernetes.io/docs/concepts/overview/components/#etcd[etcd.]に保持されます。etcdノードはetcdデータベースを実行します。
...
各https://kubernetes.io/docs/concepts/architecture/nodes/[ワーカーノード]は次のように実行されます：
