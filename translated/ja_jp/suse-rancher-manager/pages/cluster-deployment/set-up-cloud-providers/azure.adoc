...
.重要:
====
Kubernetes 1.30以降では、アウトオブツリーのAzureクラウドプロバイダーを使用する必要があります。Azureクラウドプロバイダーはhttps://github.com/kubernetes/kubernetes/pull/122857[完全に削除されました]。Kubernetes 1.30にアップグレード後は機能しません。以下に示す手順は、Azureクラウドプロバイダーを設定するために依然として必要です。Azureの前提条件を完了した後に、<<_using_the_out_of_tree_azure_cloud_provider,アウトオブツリーのクラウドプロバイダーを設定できます>>。
...
https://github.com/kubernetes-sigs/azuredisk-csi-driver[Azure Disk CSIドライバー]またはhttps://github.com/kubernetes-sigs/azurefile-csi-driver[Azure File CSIドライバー]をインストールして、それぞれhttps://azure.microsoft.com/en-us/services/storage/disks/[Azure Disk]またはhttps://azure.microsoft.com/en-us/services/storage/disks/[Azure File]ボリュームにアクセスします。
