...
GCE クラウドプロバイダーに関する公式の Kubernetes ドキュメントはhttps://github.com/kubernetes/website/blob/release-1.18/content/en/docs/concepts/cluster-administration/cloud-providers.md#gce[こちらです。]
