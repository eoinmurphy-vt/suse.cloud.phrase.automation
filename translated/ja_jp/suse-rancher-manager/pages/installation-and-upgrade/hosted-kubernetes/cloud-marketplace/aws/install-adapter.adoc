...
NOTE: cert-managerのhttps://cert-manager.io/docs/projects/trust/[トラストオペレーター]のような方法を使用すると、これらのタスクの一部を自動化できます。これらの方法は公式にサポートされていませんが、手動で証明書をローテーションする必要がある頻度を減らすことができます。
