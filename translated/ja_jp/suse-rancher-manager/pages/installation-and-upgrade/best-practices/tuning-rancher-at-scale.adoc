...
etcdは正確に3つのノードで実行するのが最良であり、ノードを追加すると操作速度が低下します。これは一般的なスケーリングアプローチに反するかもしれませんが、etcdのhttps://etcd.io/docs/v3.5/faq/#what-is-maximum-cluster-size[レプリケーションメカニズム]によるものです。
