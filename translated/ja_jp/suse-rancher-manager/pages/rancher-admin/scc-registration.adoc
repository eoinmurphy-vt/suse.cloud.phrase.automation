...
* 組織へのアクセス権が必要です。組織の管理者にアカウントに追加してもらうよう依頼してください。詳細については、https://scc.suse.com/docs/userguide#UG-Requesting-Access-to-an-Organizations-Account[SCCのドキュメント]およびhttps://scc.suse.com/docs/help#how-to-add-user[SCCのFAQ]を参照してください。組織の登録コードがわかっている場合は、求められたときに入力してください。
