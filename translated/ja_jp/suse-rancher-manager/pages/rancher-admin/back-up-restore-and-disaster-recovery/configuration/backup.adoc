 ...
 ** 標準のhttps://en.wikipedia.org/wiki/Cron[cron式]、例えば`+"0 * * * *"+`のように
...
. *エンドポイント*：バケットのリージョンでS3にアクセスするために使用されるhttps://docs.aws.amazon.com/general/latest/gr/s3.html[エンドポイント]。
...
| `+endpoint+`
| バケットのリージョンでS3にアクセスするために使用されるhttps://docs.aws.amazon.com/general/latest/gr/s3.html[エンドポイント]。
| ✓
