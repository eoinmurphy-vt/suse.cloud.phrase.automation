...
テンプレートパラメータを使用すると、個々のボリュームまたはボリュームのコレクションとともにSecretsを使用できます。テンプレートパラメータに関する詳細は、Kubernetes CSI開発者ドキュメントのhttps://kubernetes-csi.github.io/docs/secrets-and-credentials-storage-class.html[StorageClass Secrets]を参照してください。
...
詳細については、Linuxマニュアルページのhttps://man7.org/linux/man-pages/man8/cryptsetup.8.html[cryptsetup(8)]を参照してください。
