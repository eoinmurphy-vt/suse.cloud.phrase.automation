...
. Pythonクライアントを使用する
+
PythonスクリプトにPythonクライアントを含むファイルhttps://github.com/longhorn/longhorn-tests/blob/master/manager/integration/tests/longhorn.py[longhorn.py]をインポートし、エンドポイントからクライアントを作成します。
+
