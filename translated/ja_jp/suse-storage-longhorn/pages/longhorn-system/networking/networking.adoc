...
デプロイされたhttps://kubernetes.io/docs/concepts/extend-kubernetes/compute-storage-net/network-plugins/[CNI]によっては、すべてのKubernetesクラスターがNetworkPolicyをサポートしているわけではないことに注意してください。
