...
これらのメトリクスをスクレイピングするために、https://prometheus.io/[Prometheus]、https://graphiteapp.org/[Graphite]、https://www.influxdata.com/time-series-platform/telegraf/[Telegraf]などの収集ツールを使用し、収集したデータをhttps://grafana.com/[Grafana]などのツールで可視化できます。
...
+
Grafana内に入ったら、事前構築されたhttps://grafana.com/grafana/dashboards/17626[Longhorn example dashboard]をインポートしてください。
+
