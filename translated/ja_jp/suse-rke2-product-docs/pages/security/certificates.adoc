...
既存のCAによってクロスサインされた更新済みのCA証明書とキーを作成するための例のスクリプトがhttps://github.com/k3s-io/k3s/blob/master/contrib/util/rotate-default-ca-certs.sh[K3sリポジトリの`+contrib/util/rotate-default-ca-certs.sh+`]にあります。
