...
アップストリームの動作に従い、kubeletの設定は、特定のhttps://kubernetes.io/docs/tasks/administer-cluster/kubelet-config-file/#kubelet-configuration-merging-order[優先順位]に従って、さまざまな方法で変更できます。
