...
2. **Supervisor Routing**: {short-project-name} identifiziert die Absicht und leitet die Anfrage zusammen mit dem UI-Kontext an den spezialisierten Agenten (zum Beispiel den Fleet Agent) weiter.
