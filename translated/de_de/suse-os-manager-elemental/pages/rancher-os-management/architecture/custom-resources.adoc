...
Die {elemental_operator_name} ermöglicht die Steuerung der {elemental-product-name} Nodes durch die Erweiterung der Kubernetes-APIs mit einer Reihe von _elemental.cattle.io_ https://kubernetes.io/docs/tasks/extend-kubernetes/custom-resources/custom-resource-definitions/[CRDs] Kubernetes:
