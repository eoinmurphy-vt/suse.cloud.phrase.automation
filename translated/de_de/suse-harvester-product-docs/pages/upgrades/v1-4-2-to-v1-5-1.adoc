...
Sie können direkt von v1.4.2 auf v1.5.1 upgraden, da {harvester-product-name} maximal ein kleines Versionsupgrade für zugrunde liegende Komponenten zulässt. {harvester-product-name} v1.4.2 und v1.4.3 verwenden dieselbe kleine Version von {rke2-product-name} (v1.31), während {harvester-product-name} v1.5.0 und v1.5.1 die nächste kleine Version (v1.32) verwenden.
