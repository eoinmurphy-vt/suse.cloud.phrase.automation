...
. Kopieren Sie nun die Abfrage aus dem Scope in das STQL-Feld und führen Sie die Abfrage aus.
...
* Werden die Daten für diese Komponente gesammelt (entweder über den {stackstate-product-name}-Agenten oder auf andere Weise)?
