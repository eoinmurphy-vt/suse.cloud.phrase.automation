...
Lorsque cela est possible, liez d'abord les utilisateurs à un rôle moins privilégié, puis supprimez le clusterrolebinding du rôle cluster-admin{nbsp}: kubectl delete clusterrolebinding [nom]
