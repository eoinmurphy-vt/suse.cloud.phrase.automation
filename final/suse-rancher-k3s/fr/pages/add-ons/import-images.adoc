...
.Version Gate
====
La fonctionnalité de pré-importation d'images pendant que K3s est en cours d'exécution est disponible depuis les versions de janvier 2025{nbsp}: v1.32.0+k3s1, v1.31.5+k3s1, v1.30.9+k3s1, v1.29.13+k3s1. Avant cela, K3s pré-importait les images uniquement lors du démarrage.
====
...
K3s inclut deux mécanismes pour pré-importer des images dans le magasin d'images containerd{nbsp}:
...
K3s prend en charge deux alternatives pour les registres d'images{nbsp}:
