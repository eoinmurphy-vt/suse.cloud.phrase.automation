...
+
--
Dans sa forme la plus courante, le paramètre endpoint du datastore pour PostgreSQL a le format suivant{nbsp}:
...
Si vous ne fournissez que `postgres://` comme endpoint, K3s tentera de faire ce qui suit{nbsp}:
...
+
--
Dans sa forme la plus courante, le paramètre `datastore-endpoint` pour MySQL et MariaDB a le format suivant{nbsp}:
...
Si vous ne fournissez que `mysql://` comme endpoint, K3s tentera de faire ce qui suit{nbsp}:
...
+
--
Dans sa forme la plus courante, le paramètre `datastore-endpoint` pour etcd a le format suivant{nbsp}:
