...
| `K3S_LB_SERVER_PORT`
| Port local pour le répartiteur de charge du client superviseur. Si le superviseur et l'apiserver ne sont pas co-localisés, un port supplémentaire, inférieur de 1 à ce port, sera également utilisé pour le répartiteur de charge du client apiserver. (par défaut{nbsp}: 6444)
|===
...
Voici un exemple montrant comment ajouter des étiquettes et un taint{nbsp}:
