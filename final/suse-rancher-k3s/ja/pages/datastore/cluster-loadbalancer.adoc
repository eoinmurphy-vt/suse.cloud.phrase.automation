...
----
ここで、`INSTALL_K3S_ARTIFACT_URL`は https://scc.suse.com/rancher-docs/rancherprime/latest/en/reference-guide.html#prime-artifacts-url[プライムアーティファクトURL]です。
+
...
----
+
または https://docs.nginx.com/nginx/admin-guide/installing-nginx/installing-nginx-open-source/[nginxをインストール]してから実行します:
+
[,bash]
----
