...
K3sの https://github.com/k3s-io/k3s/issues/1093[既知の問題]のため、`tls`パラメータを設定することはできません。TLS通信はサポートされていますが、たとえば、このパラメータを「skip-verify」に設定してK3sが証明書の検証をスキップすることはできません。
