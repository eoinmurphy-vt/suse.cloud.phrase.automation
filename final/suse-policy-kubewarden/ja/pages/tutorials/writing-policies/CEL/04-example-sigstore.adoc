...
CELでこれを達成するために、ポリシー内で https://github.com/kubewarden/cel-policy?tab=readme-ov-file#host-capabilities[{project-name}のCEL拡張機能ライブラリ]を使用し、特に https://pkg.go.dev/github.com/kubewarden/cel-policy/internal/cel/library#Sigstore[`githubAction`の関数]を使用します。
