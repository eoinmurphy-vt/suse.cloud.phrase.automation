...
これは*本番環境のデプロイメントには適していません*。Jaegerの https://www.jaegertracing.io/docs/latest/kubernetes/[公式ドキュメント]を参照してください。
...
再度、これは*本番環境でのデプロイには不適切です*。Jaegerの https://www.jaegertracing.io/docs/latest/kubernetes/[公式ドキュメント]を参照してください。
