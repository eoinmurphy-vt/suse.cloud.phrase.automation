...
Kubernetes v1.26以降、 https://kubernetes.io/docs/reference/access-authn-authz/validating-admission-policy/[ValidatingAdmissionPolicy]は、KubernetesでカスタムAdmissionポリシーを記述する方法を提供します。ポリシーは、 https://cel.dev/[Common Expression Language (CEL)]を使用して記述され、いくつかの https://kubernetes.io/docs/reference/using-api/cel/[Kubernetes特有の拡張]が追加されています。
