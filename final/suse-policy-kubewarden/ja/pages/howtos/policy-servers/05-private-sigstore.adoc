...
* ローカルにインストールされた https://docs.sigstore.dev/cosign/system_config/installation/[`cosign`] CLI。
* ローカルにインストールされた https://jqlang.org/[`jq`]
...
両方のコマンドのすべての利用可能なフラグとJSONフィールド定義の完全な説明については、 https://docs.sigstore.dev/cosign/system_config/installation/[cosign CLIリファレンス]および https://github.com/sigstore/protobuf-specs[Sigstoreクライアント信頼設定仕様]を参照してください。
