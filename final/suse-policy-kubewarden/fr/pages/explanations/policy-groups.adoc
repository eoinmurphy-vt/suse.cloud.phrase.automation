...
.Un `ClusterAdmissionPolicyGroup` qui rejette les Pods utilisant des images avec le tag `latest`, à moins que les images ne soient signées par deux parties de confiance{nbsp}: Alice et Bob.
[%collapsible]
======
[,yaml]
----
...
Par exemple, étant donné l'expression suivante{nbsp}:
