...
La plupart des RBAC ne sont pas concernés par cette décision. Cependant, l'équipe {short-project-name} vise à{nbsp}:
...
* utilisant des images non signées et malveillantes pour{nbsp}:
