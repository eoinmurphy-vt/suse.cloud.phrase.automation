...
Pour résoudre ce problème, il est nécessaire de configurer l'application ArgoCD pour ignorer{nbsp}:
...
Vous faites cela en ajoutant le champ `ignoreDifferences` dans l'application ArgoCD{nbsp}:
