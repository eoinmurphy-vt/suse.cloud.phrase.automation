...
Artifact Hub est flexible et vous permet d'organiser votre code de ces manières{nbsp}:

* Avoir un dépôt Git dédié à Artifact Hub{nbsp}: ce dépôt ne contiendra aucun code source de stratégie. Ce sera une collection des fichiers YAML requis par Artifact Hub.
