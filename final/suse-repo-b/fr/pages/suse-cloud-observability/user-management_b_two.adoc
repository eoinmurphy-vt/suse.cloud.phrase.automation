...
* *stackstate-k8s-troubleshooter*: Les utilisateurs de ce groupe se voient attribuer le rôle de client `stackstate-k8s-troubleshooter` Keycloak, qui correspond au rôle SUSE Cloud Observability du même nom. Le rôle accorde les autorisations habituelles de SUSE Cloud Observability.
