...
. Sélectionnez *Continuous Delivery* dans le menu{nbsp}:
...
. Ajoutez le contenu suivant au nouveau fichier{nbsp}:
+
[source,yaml]
----
...
. Appliquez le fichier au cluster Rancher Manager en utilisant *kubectl*{nbsp}:
+
[source,bash]
----
