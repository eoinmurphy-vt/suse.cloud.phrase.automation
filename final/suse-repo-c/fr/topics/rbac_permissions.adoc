...
|xref:/setup/security/authentication/service_tokens.adoc[Les jetons de service] authentifient un service externe et peuvent être utilisés pour l'ingestion de données.
