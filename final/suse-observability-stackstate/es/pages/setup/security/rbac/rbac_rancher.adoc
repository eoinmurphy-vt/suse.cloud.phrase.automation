...
Observador:: Permite acceder a los datos procedentes de los espacios de nombres de un *proyecto*. Puede utilizarlo en la sección *Membresía del proyecto* de la configuración del clúster.
Observador de grupos:: Permite acceder a todos los datos procedentes de un *Cluster*. Puede utilizar esta plantilla en la sección *Membresía del* clúster de la configuración del clúster.
