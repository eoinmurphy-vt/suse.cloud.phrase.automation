...
OTLPエクスポータ（これがデフォルトです）と https://opentelemetry.io/docs/languages/java/instrumentation/#_autoconfiguration[自動構成]を使用していることを確認してください。アプリケーションをデプロイする際、サービス名とエクスポーターはxref:/setup/otel/languages/sdk-exporter-config.adoc[環境変数を介して設定されます]。
