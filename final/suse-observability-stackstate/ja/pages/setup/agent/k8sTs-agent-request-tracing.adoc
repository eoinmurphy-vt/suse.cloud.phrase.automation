...
envoyでは、`X-Request-Id`ヘッダーは`generate_request_id: true`と`always_set_request_id_in_response: true`を設定することで有効にできます https://www.envoyproxy.io/docs/envoy/latest/api-v3/extensions/filters/network/http_connection_manager/v3/http_connection_manager.proto[http接続]
