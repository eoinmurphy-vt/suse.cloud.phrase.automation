...
そのバージョンを持っていない場合は、まず標準の https://docs.stackstate.com/6.0/self-hosted-setup/upgrade-stackstate/steps-to-upgrade#_minor_or_maintenance_stackstate_release[アップグレード手順]に従ってアップグレードしてください。
