...
修正ヒントは、モニターが発火したときにユーザーが問題の原因を見つけるのを助けるためにあります。修正ヒントは https://en.wikipedia.org/wiki/Markdown[マークダウン]で書かれています。次の例のように、ハンドルバーズテンプレートを使用して、モニター結果の時系列にあるラベルを使用することも可能です。
