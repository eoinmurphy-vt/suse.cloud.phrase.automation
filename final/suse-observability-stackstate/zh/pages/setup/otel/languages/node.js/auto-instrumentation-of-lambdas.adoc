...
请参阅此页面以获取 xref:/setup/otel/proxy-collector.adoc[关于如何设置作为 SUSE Observability 安全代理的批处理收集器的指导和说明]。
请参阅此页面以获取 xref:/setup/otel/collector.adoc[关于如何设置也进行尾部采样的收集器的说明]。
有关 OpenTelemetry Collector 上处理器配置的更多信息，请参见 https://github.com/open-telemetry/opentelemetry-collector/blob/main/processor/README.md[官方文档]。
...
有关配置 OpenTelemetry 收集器身份验证的更多信息，请参阅 https://github.com/open-telemetry/opentelemetry-collector/blob/main/config/configauth/README.md[官方文档]。
