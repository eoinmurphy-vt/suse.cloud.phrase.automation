...
[NOTE]
这仅适用于 Rancher 2.12 或更高版本。 您需要 https://documentation.suse.com/cloudnative/rancher-manager/latest/en/rancher-admin/users/authn-and-authz/configure-oidc-provider.html[将 Rancher 配置为 OIDC 提供者]。
