...
. Ajoutez les annotations ci-dessous lors du lancement d'un pod qui expose des métriques via un point de terminaison OpenMetrics. Ajoutez ce qui suit{nbsp}:
...
----
 ...
 ...
----
. Vous pouvez également ajouter une configuration et des filtres optionnels{nbsp}:
