...
Vous pouvez vous authentifier en utilisant la clé API en ajoutant l'en-tête `sts-api-key` aux requêtes remote_write de Prometheus. L'exemple suivant montre comment configurer cela{nbsp}:
