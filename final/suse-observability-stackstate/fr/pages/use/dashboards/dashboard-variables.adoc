...
De même, les variables de liste qui n'autorisent pas de valeurs multiples ou qui n'incluent pas "Tout" sont interpolées comme la valeur de l'élément sélectionné dans la liste.
