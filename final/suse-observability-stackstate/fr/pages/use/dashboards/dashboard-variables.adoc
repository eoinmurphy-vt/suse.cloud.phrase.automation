...
Une fois qu'une variable est définie, elle peut être utilisée pour remplir divers champs dans le tableau de bord{nbsp}:

* Autres variables
* Nom et description du widget
* Champs de lien du widget{nbsp}: URL, Nom et Info-bulle
* Champs de requête de widget{nbsp}: Expression PromQL, Alias et Min Step
...
Les variables de liste qui ont l'option "Inclure tout" activée et sélectionnée pour cette variable seront interpolées comme{nbsp}:
