...
Les possibilités de configuration sont plus nombreuses pour contrôler les exigences et le comportement exacts de l'exportateur. Par exemple, il est également possible d'utiliser un certificat racine CA personnalisé ou d'activer les certificats clients. Voir la https://github.com/open-telemetry/opentelemetry-collector/blob/main/exporter/otlpexporter/README.md[documentation de l'exportateur OTLP sur] pour plus de détails.
