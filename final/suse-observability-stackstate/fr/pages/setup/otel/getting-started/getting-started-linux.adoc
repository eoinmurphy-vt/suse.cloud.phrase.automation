...
Tout d'abord, nous allons installer le collecteur. Nous le configurons pour{nbsp}:
...
Enfin, redémarrez le collecteur{nbsp}:
...
Pour voir les journaux du collecteur, utilisez{nbsp}:
...
La manière courante de collecter des données de télémétrie est d'instrumenter votre application en utilisant les SDK Open Telemetry. Nous avons documenté quelques guides de démarrage rapide pour quelques langages, mais il y en a beaucoup d'autres{nbsp}:
