...
Configurer la surveillance pour une ou plusieurs fonctions AWS Lambda{nbsp}:
...
Nous installons le collecteur à l'aide d'un Helm chart fourni par le projet Open Telemetry. Assurez-vous d'avoir configuré le dépôt des Helm charts Open Telemetry{nbsp}:
