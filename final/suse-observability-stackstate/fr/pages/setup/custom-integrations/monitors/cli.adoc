...
Vous pouvez xref:use/alerting/k8s-add-monitors-cli.adoc#_verifying_the_results_of_a_monitor[vérifier les résultats du moniteur] sur la page d'aperçu du moniteur.
