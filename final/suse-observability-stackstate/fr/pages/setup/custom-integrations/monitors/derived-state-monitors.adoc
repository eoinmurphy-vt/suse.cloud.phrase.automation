...
Un moniteur implémenté en utilisant la fonction `derived-state-monitor` ressemble à{nbsp}:
...
Le moniteur peut être implémenté en utilisant le guide xref:use/alerting/k8s-dynamic-threshold-monitors.adoc[Ajouter un moniteur de seuil aux composants en utilisant la CLI]
