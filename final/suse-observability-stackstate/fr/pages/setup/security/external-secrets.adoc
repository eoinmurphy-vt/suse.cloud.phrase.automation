...
Créez un secret dans l'espace de noms où SUSE Observability est installé, sous la forme suivante, en remplissant les blancs{nbsp}:
...
Ajoutez ce qui suit à votre commande helm install pour utiliser le secret{nbsp}:
