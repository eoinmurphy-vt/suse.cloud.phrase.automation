...
Pour une meilleure sécurité, SUSE Observability peut être configuré pour utiliser exactement l'un des mécanismes d'authentification suivants (remplaçant l'administrateur standard){nbsp}:
