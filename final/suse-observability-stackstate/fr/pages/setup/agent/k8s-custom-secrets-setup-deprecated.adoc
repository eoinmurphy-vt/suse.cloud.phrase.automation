...
* `stackstate.customClusterAuthTokenSecretKey`: (Facultatif) Nom de la clé pour le jeton d'autorisation du cluster dans le secret personnalisé. Requis si `stackstate.manageOwnSecrets` est défini sur `true`.
