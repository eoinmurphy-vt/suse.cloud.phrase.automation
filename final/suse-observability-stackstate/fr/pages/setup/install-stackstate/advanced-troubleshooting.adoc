...
* `Zookeeper`: Zookeeper est utilisé pour la découverte de services, l'orchestration et le basculement. Zookeeper est déployé à l'aide d'un ou plusieurs pods portant le nom :
