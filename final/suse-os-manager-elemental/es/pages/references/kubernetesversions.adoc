...
La lista de versiones válidas para el campo `kubernetesVersion` puede determinarse a partir de los metadatos de Rancher utilizando los siguientes comandos.
