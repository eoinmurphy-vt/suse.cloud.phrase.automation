...
Rancher隔离安装应根据 https://documentation.suse.com/cloudnative/rancher-manager/latest/en/installation-and-upgrade/other-installation-methods/air-gapped/air-gapped.html[官方Rancher文档]进行配置。
...
所有必需的步骤可以通过在具有互联网访问权限的主机上执行 https://raw.githubusercontent.com/rancher/elemental-operator/main/scripts/elemental-airgap.sh[`elemental-airgap.sh`脚本]来完成。
