...
[WARNING]
====
Lorsqu'une restauration est effectuée, ne redémarrez pas le `rancher-system-agent` sur les nœuds élémentaires, car cela peut devenir périmé et se terminer par l'erreur suivante{nbsp}:
...
Exécutez le script sans options supplémentaires{nbsp}:
