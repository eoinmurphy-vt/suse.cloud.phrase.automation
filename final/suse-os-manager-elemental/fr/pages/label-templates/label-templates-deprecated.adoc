...
Pour simplifier l'adoption des nouvelles variables, consultez les tableaux qui font correspondre les variables dont la prise en charge a cessé aux nouvelles prises en charge{nbsp}:
