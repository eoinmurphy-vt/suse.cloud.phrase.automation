...
Voir cet exemple de `MachineRegistration`{nbsp}:
...
== Étape 3{nbsp}: Démarrez l'appareil cible
...
Cliquez sur "Avancé" et dans le panneau de droite, changez le type de firmware de "BIOS" à "UEFI" et cochez l'option "Activer le démarrage sécurisé" comme suit{nbsp}:
