...
Le conteneur OS peut maintenant être construit et poussé vers votre registre{nbsp}:
...
L'image OS personnalisée peut également être utilisée telle quelle pour construire une image disque brute bootable{nbsp}:
