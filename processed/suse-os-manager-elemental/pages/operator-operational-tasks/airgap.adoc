...
A Rancher air-gapped installation should be already configured as per the https://documentation.suse.com/cloudnative/rancher-manager/latest/en/installation-and-upgrade/other-installation-methods/air-gapped/air-gapped.html[official Rancher documentation].
