...
You can xref:use/alerting/k8s-add-monitors-cli.adoc#_verifying_the_results_of_a_monitor[verify the results of the monitor] on the monitor overview page.
