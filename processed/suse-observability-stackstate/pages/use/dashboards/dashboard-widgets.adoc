...
image::dashboards/add-a-widget.png[Different ways to add a widget]
...
image::dashboards/add-existing-widget.png[Adding an existing widget]

This is also available for any pinned items, via the same "more actions" menu on an individual widget.

Additionally, you can add all pinned items to a dashboard, by using the "more actions" in the pinned items drawer or by clicking the "Add all items to dashboard" button at the bottom of the drawer.

image::dashboards/add-all-pinned-items.png[Adding all pinned items]

The resulting widgets in the dashboard has a link to the resource it was added from.

== Configuring a widget

Each widget has a number of configuration options. Some are common to all widgets, others are based on the widget type.

To edit a widget's configuration, use the "more actions" menu and select "Edit widget".

image::dashboards/configure-a-widget.png[Adding all pinned items]
...
image::dashboards/time-series-chart-example.png[Example time series chart]
...
image::dashboards/bar-chart-example.png[Example bar chart]
...
image::dashboards/gauge-chart-example.png[Example gauge chart]
...
image::dashboards/stat-chart-example.png[Example stat chart]
...
image::dashboards/markdown-chart-example.png[Example markdown chart]
