...
Additionally, <<Persistent names of certain network interfaces may change during upgrade,persistent names of certain Intel network interfaces may change>> during upgrades. This breaks connectivity on the host and requires manual remediation steps.
====
