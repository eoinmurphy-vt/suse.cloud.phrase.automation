...
Do you need to...
* Monitor private git or Helm repositories? Check xref:how-tos-for-users/gitrepo-add.adoc[Create a GitRepo Resource].
* Customise your deployments per target cluster? xref:how-tos-for-users/gitrepo-targets.adoc[Mapping to Downstream Clusters].
