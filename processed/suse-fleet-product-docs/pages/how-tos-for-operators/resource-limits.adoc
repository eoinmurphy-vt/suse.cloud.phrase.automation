...
The `+resources+` fields described on this page still apply. Specify the fields nested under the `+fleet+` key in the ConfigMap.

For more information, refer to xref:reference/ref-configuration.adoc[Configuration].
====
