...
== SEE ALSO
* xref:/reference/cli/fleet-agent/fleet-agent_clusterstatus.adoc[fleet-agent clusterstatus]     - Continuously report resource status to the upstream cluster
* xref:/reference/cli/fleet-agent/fleet-agent_register.adoc[fleet-agent register] - Register agent with an upstream cluster
