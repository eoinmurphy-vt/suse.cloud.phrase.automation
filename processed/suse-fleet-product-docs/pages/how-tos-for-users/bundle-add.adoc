...
[Note]
====
You can use Fleet CLI to convert a Helm chart into a `+bundle+`. For more information, refer to xref:how-tos-for-users/install-use-fleet-cli.adoc[Convert a Helm chart into a bundle using CLI.].
====