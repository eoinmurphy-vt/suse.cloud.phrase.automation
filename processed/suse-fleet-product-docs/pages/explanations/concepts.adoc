 ...
 ** To see the *life cycle of a bundle*, click xref:explanations/ref-bundle-stages.adoc[bundle lifecycle].
 ...
 ** For an example of how to deploy Kubernetes manifests across clusters using {product_name} customization, click xref:how-tos-for-users/gitrepo-targets.adoc#_customization_per_cluster[customization per cluster].
