...
. {xref-user-api-keys}#_creating_an_api_key[Create] a Rancher API key with no scope.
...
In this example, we'll show how to use kubectl to create a project, followed by deleting it. For a list of other Rancher resources available, refer to the {xref-api-reference}[API Reference] page.
