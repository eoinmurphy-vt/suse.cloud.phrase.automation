...
Resource quotas can also be set when a new project is created. For details, refer to the section on {xref-projects-and-namespaces}#_creating_projects[creating new projects.]

Resource quotas in Rancher include the same functionality as the https://kubernetes.io/docs/concepts/policy/resource-quotas/[native version of Kubernetes]. In Rancher, resource quotas have been extended so that you can apply them to projects. For details on how resource quotas work with projects in Rancher, refer to {xref-project-resource-quotas}[this page.]
...
. Select a Resource Type. For more information on types, see the {xref-resource-quota-types}[quota type reference.]
