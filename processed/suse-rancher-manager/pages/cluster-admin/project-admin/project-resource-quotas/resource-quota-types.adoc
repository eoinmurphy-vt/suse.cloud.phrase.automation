...
When you create a resource quota, you are configuring the pool of resources available to the project. Rancher supports the use of arbitrary resource references and their quotas. This allows you to utilize all upstream https://kubernetes.io/docs/concepts/policy/resource-quotas/#types-of-resource-quota[Kubernetes `+ResourceQuota+`] types when managing project resource quotas.
...
| Memory Limit*
| The maximum amount of memory (in https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#meaning-of-memory[bytes]) allocated to the project/namespace.^1^
...
| Custom**
| The specification of arbitrary resources and their quotas, beyond the resource types built into projects, as listed above.
|===
...
See the https://kubernetes.io/docs/concepts/policy/resource-quotas/#quota-for-extended-resources[Kubernetes documentation] for many more examples.
====
