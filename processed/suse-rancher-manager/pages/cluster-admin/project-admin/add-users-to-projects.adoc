...
Want to provide a user with access to _all_ projects within a cluster? See {xref-cluster-project-roles}[Adding Cluster Members] instead.
====
...
You can add members to a project as you create it (recommended if possible). For details on creating a new project, refer to the {xref-projects-and-namespaces}[cluster administration section.]
...
+
{xref-cluster-project-roles}[What are Project Roles?]
+
