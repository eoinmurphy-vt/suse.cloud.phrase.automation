...
For more information about each installation option, refer to {xref-install-upgrade}[this page.]
...
For an example of one way to set up the MySQL database, refer to this {xref-mysql-amazon-rds}[tutorial] for setting up MySQL on Amazon's RDS service.
