...
Alternatively, in order to make such changes permanent, these environment variables can be set by {xref-helm-chart-options}#_setting_extra_environment_variables[using Helm values] instead.
