...
This section describes how to install a Kubernetes cluster according to the {xref-arch-rec}#_environment_for_kubernetes_installations[best practices for the Rancher server environment.]
...
These instructions assume you have set up two nodes, a load balancer, a DNS record, and an external MySQL database as described in {xref-ha-k3s}[this section.]
