...
This section describes how to install a Kubernetes cluster according to our {xref-arch-rec}#_environment_for_kubernetes_installations[best practices for the Rancher server environment.] This cluster should be dedicated to run only the Rancher server.
