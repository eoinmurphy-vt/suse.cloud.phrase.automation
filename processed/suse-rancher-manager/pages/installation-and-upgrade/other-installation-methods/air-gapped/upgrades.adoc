...
These instructions assume you have already followed the instructions for a Kubernetes upgrade on {xref-rancher-upgrades}[this page,] including the prerequisites, up until step 3. Upgrade Rancher.
====
