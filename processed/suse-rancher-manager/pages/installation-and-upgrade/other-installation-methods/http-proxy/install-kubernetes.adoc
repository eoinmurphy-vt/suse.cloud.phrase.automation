...
For more information on installing K3s see the {url-k3s-installation}[K3s installation docs].
...
Next create the RKE2 configuration file on every node following the {url-rke2-install-ha}[RKE2 High Availability documentation].
...
For more information on installing RKE2 see the {url-rke2-introduction}[RKE2 documentation].
...
See the {xref-install-upgrade-troubleshooting}[Troubleshooting] page.
