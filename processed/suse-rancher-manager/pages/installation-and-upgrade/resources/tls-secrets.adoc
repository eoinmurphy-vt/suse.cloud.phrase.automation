...
Follow the steps on {xref-update-rancher-cert}[this page] to update the SSL certificate of the ingress in a Rancher {xref-install-rancher}[high availability Kubernetes installation] or to switch from the default self-signed certificate to a custom certificate.
