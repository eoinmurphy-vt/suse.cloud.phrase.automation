...
. Follow the guide to {xref-air-gap-publish-images}[Prepare your Private Registry] with the images needed for the upgrade.
...
Rancher now supports cert-manager versions 1.6.2 and 1.7.1. We recommend v1.7.x because v 1.6.x will reach end-of-life on March 30, 2022. To read more, see the {xref-install-rancher}#_4_install_cert_manager[cert-manager docs]. For instructions on upgrading cert-manager from version 1.5 to 1.6, see the upstream cert-manager documentation https://cert-manager.io/docs/installation/upgrading/upgrading-1.5-1.6/[here]. For instructions on upgrading cert-manager from version 1.6 to 1.7, see the upstream cert-manager documentation https://cert-manager.io/docs/installation/upgrading/upgrading-1.6-1.7/[here].
