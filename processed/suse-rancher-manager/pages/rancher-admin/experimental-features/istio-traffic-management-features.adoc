...
____
*Prerequisite:* Turning on this feature does not enable Istio. A cluster administrator needs to {xref-istio-guides}[enable Istio for the cluster] in order to use the feature.
____
