...
* {xref-ms-adfs-for-rancher}[1. Configuring Microsoft AD FS for Rancher]
* {xref-rancher-for-ms-adfs}[2. Configuring Rancher for Microsoft AD FS]
...
=== {xref-ms-adfs-for-rancher}[Next: Configuring Microsoft AD FS for Rancher]
