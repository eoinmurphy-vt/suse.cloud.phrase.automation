...
If you prefer to use Keycloak with the SAML protocol instead, refer to {xref-keycloak-saml}[this page].
...
. Manually edit the `+authconfig/keycloakoidc+` object to enable group search.
