...
____
Before you proceed with the configuration, please familiarize yourself with the concepts of {xref-authn-authz}#_external_authentication_configuration_and_principal_users[External Authentication Configuration and Principal Users].
____
...
If you are in doubt about the correct values to enter in the user/group Search Base configuration fields, consult your LDAP administrator or refer to the section {xref-configure-ad}#_annex_identify_search_base_and_schema_using_ldapsearch[Identify Search Base and Schema using ldapsearch] in the Active Directory authentication documentation.
