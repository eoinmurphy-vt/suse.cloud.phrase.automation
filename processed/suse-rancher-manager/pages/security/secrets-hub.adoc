...
This page is about secrets in general. For details on setting up a private registry, refer to the section on {xref-k8s-docker-registries}[registries.]
====
...
For more information on adding secret to a workload, see {xref-deploy-workloads}[Deploying Workloads].
