...
| 30 Apr 2026
| Rancher https://github.com/rancher/rancher/releases/tag/v2.14.1[v2.14.1], https://github.com/rancher/rancher/releases/tag/v2.13.5[v2.13.5], https://github.com/rancher/rancher/releases/tag/v2.12.9[v2.12.9], and  https://github.com/rancher/rancher/releases/tag/v2.11.13[v2.11.13]
...
| 29 Jan 2026
| Rancher https://github.com/rancher/rancher/releases/tag/v2.13.2[v2.13.2], https://github.com/rancher/rancher/releases/tag/v2.12.6[v2.12.6], https://github.com/rancher/rancher/releases/tag/v2.11.10[v2.11.10], and  https://github.com/rancher/rancher/releases/tag/v2.10.11[v2.10.11]

| https://github.com/rancher/rancher/security/advisories/GHSA-mc24-7m59-4q5p[CVE-2025-67601]
| Rancher now removes the ability to fetch CA certificates stored in Rancher’s setting `+cacerts+` when using the `+login+` command. 
| 29 Jan 2026
| Rancher https://github.com/rancher/rancher/releases/tag/v2.13.2[v2.13.2], https://github.com/rancher/rancher/releases/tag/v2.12.6[v2.12.6], https://github.com/rancher/rancher/releases/tag/v2.11.10[v2.11.10], and  https://github.com/rancher/rancher/releases/tag/v2.10.11[v2.10.11]
