...
This section describes how to use `+firewalld+` to apply the {xref-install-reqs}#_port_requirements[firewall port rules] for nodes in a high-availability Rancher server cluster.
