...
For more information about how the logging application works, see {xref-logging-architecture}[this section.]

[#_role_based_access_control]
== Role-based Access Control

Rancher logging has two roles, `+logging-admin+` and `+logging-view+`. For more information on how and when to use these roles, see {xref-logging-rbac}[this page.]
...
For help with configuring `+Flows+` and `+ClusterFlows+`, see {xref-logging-flows-clusterflows}[this page.]

[#_outputs_and_clusteroutputs]
=== Outputs and ClusterOutputs

For help with configuring `+Outputs+` and `+ClusterOutputs+`, see {xref-logging-outputs-clusteroutputs}[this page.]
...
For a list of options that can be configured when the logging application is installed or upgraded, see {xref-logging-helm-chart-options}[this page.]
...
For information on how to use taints and tolerations with the logging application, see {xref-logging-taints-and-tolerations}[this page.]
