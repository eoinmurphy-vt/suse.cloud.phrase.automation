...
The resource requests and limits for the monitoring application can be configured when installing `+rancher-monitoring+`. For more information about the default limits, see {xref-helm-chart-options}#_configuring_resource_limits_and_requests[this page.]
...
For details, see {xref-servicemonitors-and-podmonitors}[this page.]

[#_advanced_prometheus_configuration]
=== Advanced Prometheus Configuration

For more information about directly editing the Prometheus custom resource, which may be helpful in advanced use cases, see {xref-prometheus}[this page.]
...
For some advanced use cases, you may want to configure alertmanager directly. For more information, refer to {xref-configure-alertmanager}[this page.]

[#_receivers]
=== Receivers

Receivers are used to set up notifications. For details on how to configure receivers, see {xref-receivers}[this page.]

[#_routes]
=== Routes

Routes filter notifications before they reach receivers. Each route needs to refer to a receiver that has already been configured. For details on how to configure routes, see {xref-monitoring-routes}[this page.]

[#_advanced]
=== Advanced

For more information about directly editing the Alertmanager custom resource, which may be helpful in advanced use cases, see {xref-configure-alertmanager}[this page.]
