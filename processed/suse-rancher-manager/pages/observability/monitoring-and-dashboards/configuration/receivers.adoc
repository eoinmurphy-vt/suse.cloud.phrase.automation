...
This section assumes familiarity with how monitoring components work together. For more information about Alertmanager, see {xref-how-monitoring-works}#_3_how_alertmanager_works[this section.]
====
...
For more information on enabling alerting for `+rancher-compliance+`, see {xref-compliance-enable-alerting}[this section.]
