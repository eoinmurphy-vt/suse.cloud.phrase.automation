...
To view and customize the PromQL queries powering the Grafana dashboard, see {xref-customize-grafana-dashboard}[this page.]

[#_persistent_grafana_dashboards]
=== Persistent Grafana Dashboards

To create a persistent Grafana dashboard, see {xref-create-persistent-grafana-dashboard}[this page.]
...
For more information on configuring Alertmanager in Rancher, see {xref-configure-alertmanager}[this page.]
...
For more information on configuring PrometheusRules in Rancher, see {xref-prometheusrules}[this page.]
