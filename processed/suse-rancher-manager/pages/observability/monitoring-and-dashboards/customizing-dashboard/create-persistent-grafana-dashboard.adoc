...
* To see the links to the external monitoring UIs, including Grafana dashboards, you will need at least a {xref-rancher-monitoring-rbac}#_users_with_rancher_based_permissions[project-member role.]
====
