...
For details, refer to {xref-selectors-and-scrape-configurations}[this section.]
...
Refer to {xref-istio-on-rke2}[this section.]

[#_additional_steps_for_project_network_isolation]
== Additional Steps for Project Network Isolation

Refer to {xref-istio-project-network-isolation}[this section.]
