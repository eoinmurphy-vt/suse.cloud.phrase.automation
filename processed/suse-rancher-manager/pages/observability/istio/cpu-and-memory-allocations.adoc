...
. Click *Upgrade* to edit the base components via changes to the values.yaml or add an {xref-istio-config}#_overlay_file[overlay file]. For more information about editing the overlay file, see <<_editing_the_overlay_file,this section.>>
