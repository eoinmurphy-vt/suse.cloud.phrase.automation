...
Optional: You can configure which namespaces data scraping occurs in by setting the Helm chart options described in {xref-selectors-and-scrape-configurations}[Selectors & Scrape Configs].
