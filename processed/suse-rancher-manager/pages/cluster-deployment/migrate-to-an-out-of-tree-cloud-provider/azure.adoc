 ...
 ** UI: Follow steps 1-10 of {xref-azure-cloud-provider}#_helm_chart_installation_from_ui[Helm chart installation from UI] to install the cloud controller manager chart.
 ** CLI: Follow steps 1-4 of {xref-azure-cloud-provider}#_helm_chart_installation_from_cli[Helm chart installation from CLI].
 ** Update the cluster's additional manifest: Follow steps 2-3 to {xref-azure-cloud-provider}#_using_the_out_of_tree_azure_cloud_provider[install the cloud controller manager chart].
 ...
 ** UI: Follow steps 1-10 of {xref-azure-cloud-provider}#_helm_chart_installation_from_ui[Helm chart installation from UI] to install the cloud controller manager chart.
 ** CLI: Follow steps 1-4 of {xref-azure-cloud-provider}#_helm_chart_installation_from_cli[Helm chart installation from CLI] to install the cloud controller manager chart.
