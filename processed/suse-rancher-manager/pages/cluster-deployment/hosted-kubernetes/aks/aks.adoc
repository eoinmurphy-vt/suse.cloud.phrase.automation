...
. Click *Create*.
. Click *Azure*.
. Fill out the form. For help with filling out the form, see the {xref-deploy-aks-config}#_cloud_credentials[configuration reference.]
. Click *Create*.
...
. Click *Azure AKS*.
. Fill out the form. For help with filling out the form, see the {xref-deploy-aks-config}[configuration reference.]
. Click *Create*.
...
For more information about how to configure AKS clusters from the Rancher UI, see the {xref-deploy-aks-config}[configuration reference.]
...
The AKS provisioner can synchronize the state of an AKS cluster between Rancher and the provider. For an in-depth technical explanation of how this works, see {xref-sync-hosted-clusters}[Syncing.]

For information on configuring the refresh interval, see {xref-gke-config}#_configuring_the_refresh_interval[this section.]
