...
. Fill out the rest of the form. For help, refer to the {xref-gke-config}[GKE cluster configuration reference.]
. Click *Create*.
...
Private GKE clusters are supported. Note: This advanced setup can require more steps during the cluster provisioning process. For details, see {xref-gke-private-clusters}[this section.]

[#_configuration_reference]
== Configuration Reference

For details on configuring GKE clusters in Rancher, see {xref-gke-config}[this page.]
...
The GKE provisioner can synchronize the state of a GKE cluster between Rancher and the provider. For an in-depth technical explanation of how this works, see {xref-sync-hosted-clusters}[Syncing.]
