...
[IMPORTANT]
====
Rancher v2.14 ships CAPI v1.12.2 and adopts the new `+v1beta2+` API contract. Refer to xref:tutorials/capi-v1beta2.adoc[Upgrading to CAPI v1beta2] for more details on the changes introduced in this new API version.
====
...
If this is your first time using {product_name} and you want to get started quickly, we recommend the xref:tutorials/first-cluster.adoc[Create & Import Your First Cluster guide]. This will guide you through the process of using CAPI to provision a new workload cluster and importing it into Rancher.
