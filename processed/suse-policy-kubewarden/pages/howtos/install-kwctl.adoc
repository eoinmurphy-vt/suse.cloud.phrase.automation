...
= Installing kwctl ({project-name} CLI)
:revdate: 2026-03-18
:page-revdate: {revdate}
:title: Installing kwctl
:description: Install kwctl (the {project-name} CLI) by following its installation instructions for various operating systems, then enable shell completion.
:keywords: ["{project-name}", kubewarden, kubernetes, install kwctl, install, kwctl]
:doc-persona: kubewarden-all
:doc-type: howto
:doc-topic: install-kwctl

`+kwctl+` is the command-line interface (CLI) tool for {project-name}. Below are installation instructions for some operating systems.
...
. Download `+kwctl+`:
    .. Open your browser and go to the https://github.com/kubewarden/kwctl/releases/latest[{short-project-name} releases page].
