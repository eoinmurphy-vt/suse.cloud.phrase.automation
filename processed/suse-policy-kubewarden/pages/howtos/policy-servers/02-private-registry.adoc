...
Label the Secret as specified in
xref:/howtos/rancher-backup-operator.adoc#_user_secrets[User secrets] for it to
be part of backups done by Rancher Backup Operator
