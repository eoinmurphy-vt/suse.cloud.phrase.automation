...
https://apps.rancher.io/[Rancher Application Collection] with {project-name}.
...
documentation], create an access token and configure the cluster to pull
from the Application Collection registry, with a Docker Config Secret:
