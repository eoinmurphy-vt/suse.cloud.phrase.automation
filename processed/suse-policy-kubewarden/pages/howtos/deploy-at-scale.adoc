...
= {project-name} in a Large-Scale Environment
:revdate: 2026-03-18
:page-revdate: {revdate}
:description: Configure {project-name}s with {project-name} to ensure high availability and performance in demanding large-scale environments.
...
This section details a real-world deployment of {project-name} in a demanding, large-scale environment. It illustrates how to configure {short-project-name} for high availability and performance and what to expect under heavy load.

[IMPORTANT]
====
If you want to see more tips on how to run {short-project-name} in production, check out the xref:/howtos/production-deployments.adoc[Production deployments] documentation.
====
...
To meet the demands of this environment, {short-project-name} is configured with a focus on workload isolation and high availability.
