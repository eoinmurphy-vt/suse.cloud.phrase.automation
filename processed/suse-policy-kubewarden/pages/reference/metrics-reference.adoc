...
:description: Explore cluster metrics and patterns with {project-name}'s exposed platform metrics to inform decision-making processes.
...
{short-project-name} exposes relevant platform metrics allowing cluster administrators and
