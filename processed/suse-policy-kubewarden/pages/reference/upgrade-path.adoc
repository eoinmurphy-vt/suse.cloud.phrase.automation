...
:description: Upgrade your {project-name} stack using supported versioning strategies and compatibility rules among its components.
...
`+kwctl+` should run the same `+MAJOR+`.`+MINOR+`.`+PATCH+` version.
