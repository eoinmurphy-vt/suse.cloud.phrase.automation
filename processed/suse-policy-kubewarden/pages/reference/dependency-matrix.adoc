...
:description: Learn about the dependencies of the {project-name}, including their version constraints.
...
This page lists the dependencies of {project-name}, with their relevant
...
backwards-incompatible changes still happen. The {short-project-name} developers endeavor
...
| (deprecated, removal scheduled) `+policyreports.wgpolicyk8s.io+` CRDs
| `+v1beta1+`
...
{short-project-name} tests against the monitoring and tracing Helm charts provided in the
