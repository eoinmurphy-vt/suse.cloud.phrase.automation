...
The policies field is a map of ordinary policies. {project-name} calls policies by
...
ordinary {short-project-name} policies, containing only the `+module+`, `+settings+` and
