...
:description: Publish {project-name} policies to Artifact Hub by creating a well-formatted Git repository layout and configuring GitHub Actions for automated packaging, facilitating continuous integration.
...
{project-name} policies can be published on Artifact Hub and made
...
This document focuses on the steps required to make a {short-project-name} policy
...
* Choose _"{short-project-name} policies"_ as kind.
