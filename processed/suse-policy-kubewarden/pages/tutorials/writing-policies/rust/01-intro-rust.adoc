...
{project-name} provides a https://crates.io/crates/kubewarden-policy-sdk[Rust SDK] that simplifies the process of writing policies.
...
This documentation shows how to use these projects to write {short-project-name} policies using Rust.
It doesn't cover the details of {short-project-name}'s Rust SDK.
