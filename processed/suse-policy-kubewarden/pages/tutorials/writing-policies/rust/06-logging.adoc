...
:description: Configure logging capabilities for your policy by using the {project-name}'s integration with the SLOG library and initializing.
...
It's a popular, well known crate and integrates cleanly with {project-name}.
