...
:description: Learn how to distribute policies and access related information for {project-name}, including configuration details.
...
section of {project-name}'s documentation.
