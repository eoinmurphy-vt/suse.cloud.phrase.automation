...
As a Kubernetes cluster operator, you'll want to perform testing for {project-name} policies you want to use.
...
{short-project-name} has a utility, https://github.com/kubewarden/kwctl[`+kwctl+`],
...
The {short-project-name} policy can load from the:
