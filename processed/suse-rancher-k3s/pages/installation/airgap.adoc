...
. Obtain the images archive for your architecture from the https://scc.suse.com/rancher-docs/rancherprime/latest/en/reference-guide.html#prime-artifacts-url[Prime Artifacts URL] page for the version of K3s you will be running.
...
. On an internet accessible machine, download the images archive for your architecture from the https://scc.suse.com/rancher-docs/rancherprime/latest/en/reference-guide.html#prime-artifacts-url[Prime Artifacts URL] page for the version of K3s you plan to install. For example:
+
[,bash]
----
...
* Download the K3s binary from the https://scc.suse.com/rancher-docs/rancherprime/latest/en/reference-guide.html#prime-artifacts-url[Prime Artifacts URL] page, matching the same version used to get the airgap images. Place the binary in `+/usr/local/bin+` on each air-gapped node and ensure it is executable.
+
[,bash]
----
...
. Download the new air-gap images (tar file) from the https://scc.suse.com/rancher-docs/rancherprime/latest/en/reference-guide.html#prime-artifacts-url[Prime Artifacts URL] page for the version of K3s you will be upgrading to. Place the tar in the `+/var/lib/rancher/k3s/agent/images/+` directory on each
